    ...
    !function () {
      ...
      class hc {
        ...
        getFieldIndexes(e, t) {
          const n = fc(e),
            r = gc(e);
          return (
            t ? n.j("collectionGroupIndex", IDBKeyRange.bound(t, t)) : n.j()
          ).next((e) => {
            const s = [];
            return bi
              .forEach(e, (i) =>
                  ...
                  s.push(
                    ...
                    (n = (e = e)
                      ? new di(
                          ...
                          new mi(
                            ku(e.readTime),
                            new ai(Pi(e.documentKey)),
                            e.largestBatchId
                          )
                        )
                      : di.empty()),
                    (r = t.fields.map(
                      ([e, t]) => new li(oi.fromServerFormat(e), t)
                    )),
                    new ui(t.indexId, t.collectionGroup, r, n))
                  );
                })
              )
              .next(() => s);
        ...
        updateCollectionGroup(e, n, r) {
          const i = fc(e),
            s = gc(e);
          return this.Tn(e).next((t) =>
            i
              .j("collectionGroupIndex", IDBKeyRange.bound(n, n))
              .next((e) =>
                bi.forEach(e, (e) => s.put(Pu(e.indexId, this.user, t, r)))
              )
          );
        }
        updateIndexEntries(i, e) {
          const n = new Map();
          return bi.forEach(e, (t, r) => {
            var e = n.get(t.collectionGroup);
            return (
              e ? bi.resolve(e) : this.getFieldIndexes(i, t.collectionGroup)
            ).next(
              (e) => (
                n.set(t.collectionGroup, e),
                bi.forEach(e, (n) =>
                  this.En(i, t, n).next((e) => {
                    var t = this.An(r, n);
                    return e.isEqual(t) ? bi.resolve() : this.vn(i, r, n, e, t);
                  })
                )
              )
            );
        ...
        En(e, n, r) {
          ...
          return t
            .X(
              ...
              (e, t) => {
                i = i.add(
                  new Xu(r.indexId, n, t.arrayValue, t.directionalValue)
                );
              }
            )
            .next(() => i);
          ...
          if (null != i) {
            ...
            if (Us(s))
              for (const i of s.arrayValue.values || [])
                n = n.add(new Xu(t.indexId, e.key, this.dn(i), r));
          } else n = n.add(new Xu(t.indexId, e.key, cc, r));
          return n;
        }
        vn(t, n, r, c, e) {
          Fr(
          ...
          return (
            (function (e, n, r, i) {
              ...
              Yu,
              (e) => {
                i.push(this.Rn(t, n, r, e));
              },
              (e) => {
                i.push(this.Pn(t, n, r, e));
              }
            ),
            bi.waitFor(i)
          );
        ...
        createRange(e, t, n) {
          ...
          for (const i of n) {
            const n = Yu(i, e),
              s = Yu(i, t);
            if (0 === n) r[0] = e.Je();
            else if (0 < n && s < 0) r.push(i), r.push(i.Je());
            else if (0 < s) break;
          }
          r.push(t);
          const i = [];
        ...
        getMinOffset(t, e) {
          return bi
            .mapArray(this.cn(e), (e) => this.an(t, e).next((e) => e || Pr()))
            .next(mc);
        }
      }
      function lc(e) {
      ...
      class yc {
        ...
        static withCacheSize(e) {
          return new yc(
            e,
            yc.DEFAULT_COLLECTION_PERCENTILE,
            yc.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT
          );
        }
      }
      function vc(e, t, n) {
        ...
        let a = 0;
        const u = r.X({ range: o }, (e, t, n) => (a++, n.delete()));
        s.push(
          u.next(() => {
            Br(1 === a);
          })
      ...
      function wc(e) {
        ...
        if (e.document) t = e.document;
          ...
          if (!e.noDocument) throw Pr();
          t = e.noDocument;
        }
        return JSON.stringify(t).length;
      }
      (yc.DEFAULT_COLLECTION_PERCENTILE = 10),
        (yc.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3),
        (yc.DEFAULT = new yc(
          41943040,
          yc.DEFAULT_COLLECTION_PERCENTILE,
          yc.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT
        )),
        (yc.DISABLED = new yc(-1, 0, 0));
      class bc {
        constructor(e, t, n, r) {
          (this.userId = e),
            (this.serializer = t),
        ...
        checkEmpty(e) {
          ...
          return Ec(e)
            .X({ index: "userMutationsIndex", range: t }, (e, t, n) => {
              (r = !1), n.done();
            })
            .next(() => r);
        }
        addMutationBatch(h, l, d, f) {
          ...
          return m.add({}).next((e) => {
            Br("number" == typeof e);
            const t = new Ca(e, l, d, f),
              n =
                ((i = this.serializer),
                (s = this.userId),
                (o = t),
                (a = o.baseMutations.map((e) => pu(i.fe, e))),
                (u = o.mutations.map((e) => pu(i.fe, e))),
                {
                  userId: s,
                  batchId: o.batchId,
                  localWriteTimeMs: o.localWriteTime.toMillis(),
                  baseMutations: a,
                  mutations: u,
                }),
              r = [];
            var i, s, o, a, u;
            let c = new ps((e, t) =>
              Jr(e.canonicalString(), t.canonicalString())
            );
            for (const h of f) {
        ...
        lookupMutationBatch(e, t) {
          return Ec(e)
            .get(t)
            .next((e) =>
              e ? (Br(e.userId === this.userId), Ru(this.serializer, e)) : null
            );
        }
        Sn(e, n) {
          return this.Vn[n]
        ...
        getNextMutationBatchAfterBatchId(e, t) {
          ...
          let i = null;
          return Ec(e)
            .X({ index: "userMutationsIndex", range: n }, (e, t, n) => {
              t.userId === this.userId &&
                (Br(t.batchId >= r), (i = Ru(this.serializer, t))),
                n.done();
            })
            .next(() => i);
        }
        ...
        getAllMutationBatches(e) {
          ...
          return Ec(e)
            ...
            .next((e) => e.map((e) => Ru(this.serializer, e)));
        }
        getAllMutationBatchesAffectingDocumentKey(o, a) {
          const e = qi(this.userId, a.path),
          ...
          return _c(o)
            .X({ range: t }, (e, t, n) => {
              var [r, i, s] = e,
                i = Pi(i);
              if (r === this.userId && a.path.isEqual(i))
                return Ec(o)
                  .get(s)
                  .next((e) => {
                    if (!e) throw Pr();
                    Br(e.userId === this.userId),
                      u.push(Ru(this.serializer, e));
                  });
              n.done();
            })
            .next(() => u);
        ...
        getAllMutationBatchesAffectingDocumentKeys(t, e) {
          ...
          return (
            e.forEach((o) => {
              var e = qi(this.userId, o.path),
                e = IDBKeyRange.lowerBound(e),
                e = _c(t).X({ range: e }, (e, t, n) => {
                  var [r, i, s] = e,
                    i = Pi(i);
                  r === this.userId && o.path.isEqual(i)
                    ? (a = a.add(s))
                    : n.done();
                });
              n.push(e);
            }),
            bi.waitFor(n).next(() => this.Dn(t, a))
          );
        }
        getAllMutationBatchesAffectingQuery(e, t) {
          ...
          return _c(e)
            .X({ range: r }, (e, t, n) => {
              var [r, i, s] = e,
                i = Pi(i);
              r === this.userId && o.isPrefixOf(i)
                ? i.length === a && (u = u.add(s))
                : n.done();
            })
            .next(() => this.Dn(e, u));
        }
        ...
        removeMutationBatch(t, n) {
          return vc(t.ht, this.userId, n).next(
            (e) => (
      ...
      class xc {
        ...
        allocateTargetId(n) {
          return this.$n(n).next((e) => {
            const t = new Sc(e.highestTargetId);
            return (
              (e.highestTargetId = t.next()),
              this.On(n, e).next(() => e.highestTargetId)
            );
          });
        }
        getLastRemoteSnapshotVersion(e) {
          return this.$n(e).next((e) =>
            ni.fromTimestamp(
              new ti(
        ...
        addTargetData(t, n) {
          return this.Fn(t, n).next(() =>
            this.$n(t).next(
              (e) => ((e.targetCount += 1), this.Bn(n, e), this.On(t, e))
            )
          );
        }
        ...
        removeTargetData(t, e) {
          return this.removeMatchingKeysForTargetId(t, e.targetId)
            .next(() => Dc(t).delete(e.targetId))
            .next(() => this.$n(t))
            .next(
              (e) => (Br(0 < e.targetCount), --e.targetCount, this.On(t, e))
            );
        }
        removeTargets(r, i, s) {
          let o = 0;
          ...
          return Dc(r)
            .X((e, t) => {
              ...
              n.sequenceNumber <= i &&
                ...
                (o++, a.push(this.removeTargetData(r, n)));
            })
            .next(() => bi.waitFor(a))
            .next(() => o);
        }
        ...
        On(e, t) {
          return Ac(e).put("targetGlobalKey", t);
        }
        Fn(e, t) {
          return Dc(e).put(Fu(this.serializer, t));
        }
        Bn(e, t) {
          let n = !1;
          return (
        ...
        getTargetData(e, i) {
          ...
          let s = null;
          return Dc(e)
            .X({ range: t, index: "queryTargetsIndex" }, (e, t, n) => {
              var r = Mu(t);
              Eo(i, r.target) && ((s = r), n.done());
            })
            .next(() => s);
        }
        ...
        containsKey(e, t) {
          ...
          return Cc(e)
            .X(
              { index: "documentTargetsIndex", Y: !0, range: n },
              ([e], t, n) => {
                0 !== e && (r++, n.done());
              }
            )
      ...
      class kc {
        constructor(e) {
          (this.Ln = e), (this.buffer = new ps(Nc)), (this.qn = 0);
        }
        Un() {
          return ++this.qn;
        }
      ...
      class Rc {
        ...
        Qn(e) {
          Fr("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`),
      ...
      class Mc {
        ...
        nthSequenceNumber(e, t) {
          if (0 === t) return bi.resolve(Ri.ct);
          const n = new kc(t);
          return this.jn
        ...
        Hn(t, n) {
          ...
          return this.calculateTargetCount(t, this.params.percentileToCollect)
            ...
            .next(
              (e) => ((r = e), (a = Date.now()), this.removeTargets(t, r, n))
            )
            .next(
              (e) => (
      ...
      class Fc {
        constructor(e, t) {
          (this.db = e),
            (this.garbageCollector = ((e = this), (t = t), new Mc(e, t)));
        }
        zn(e) {
          const n = this.Jn(e);
          return this.db
        ...
        Xn(t, n) {
          let r = !1;
          return Tc(t)
            .Z((e) => Ic(t, e, n).next((e) => (e && (r = !0), bi.resolve(!e))))
            .next(() => r);
        }
                ...
                if (!e)
                  return (
                    ...
                    i
                      ...
                      .next(
                        () => (
                          i.removeEntry(t, ni.min()),
                          Cc(n).delete([0, Oi(t.path)])
                        )
                      )
                  );
              });
          ...
          return t
            .X(
              ...
              ([e], { path: t, sequenceNumber: n }) => {
                0 === e
                  ? (s !== Ri.ct && r(new ai(Pi(i)), s), (s = n), (i = t))
                  : (s = Ri.ct);
              }
            )
            .next(() => {
              s !== Ri.ct && r(new ai(Pi(i)), s);
            });
        }
        getCacheSize(e) {
      ...
      function Lc(e, t) {
        return Cc(e).put(
          ...
          { targetId: 0, path: Oi(t.path), sequenceNumber: e })
        );
      }
      class Oc {
        constructor() {
        ...
        removeEntry(e, t) {
          this.assertNotApplied(),
            this.changes.set(e, Xs.newInvalidDocument(e).setReadTime(t));
        }
        getEntry(e, t) {
          this.assertNotApplied();
          var n = this.changes.get(t);
          return void 0 !== n ? bi.resolve(n) : this.getFromCache(e, t);
        }
        getEntries(e, t) {
      ...
      class Vc {
        ...
        updateMetadata(t, n) {
          return this.getMetadata(t).next(
            (e) => ((e.byteSize += n), this.Zn(t, e))
          );
        }
        getEntry(e, n) {
          let r = Xs.newInvalidDocument(n);
          return Uc(e)
            .X(
              { index: "documentKeyIndex", range: IDBKeyRange.only(jc(n)) },
              (e, t) => {
                r = this.ts(n, t);
              }
            )
        ...
        es(e, n) {
          let r = { size: 0, document: Xs.newInvalidDocument(n) };
          return Uc(e)
            .X(
              { index: "documentKeyIndex", range: IDBKeyRange.only(jc(n)) },
              (e, t) => {
                r = { document: this.ts(n, t), size: wc(t) };
              }
            )
            .next(() => r);
        }
        ...
        ss(e, t) {
          let r = $o,
            i = new fs(ai.comparator);
          return this.ns(e, t, (e, t) => {
            var n = this.ts(e, t);
            (r = r.insert(e, n)), (i = i.insert(e, wc(t)));
          }).next(() => ({ documents: r, rs: i }));
        }
        ns(e, t, i) {
          if (t.isEmpty()) return bi.resolve();
          let n = new ps(zc);
          ...
          let o = s.getNext();
          return Uc(e)
            .X({ index: "documentKeyIndex", range: r }, (e, t, n) => {
              for (
                var r = ai.fromSegments([
                  ...t.prefixPath,
                  t.collectionGroup,
                  t.documentId,
                ]);
                ...
                i(o, null), (o = s.getNext());
              o &&
                o.isEqual(r) &&
                (i(o, t), (o = s.hasNext() ? s.getNext() : null)),
                o ? n.G(jc(o)) : n.done();
            })
            .next(() => {
              for (; o; ) i(o, null), (o = s.hasNext() ? s.getNext() : null);
            });
        }
        ...
        Zn(e, t) {
          return qc(e).put("remoteDocumentGlobalKey", t);
        }
        ts(e, t) {
          if (t) {
            const e = (function (e, t) {
              let n;
              if (t.document)
                n = mu(e.fe, t.document, !!t.hasCommittedMutations);
              else if (t.noDocument) {
                const e = ai.fromSegments(t.noDocument.path),
                  i = ku(t.noDocument.readTime);
                (n = Xs.newNoDocument(e, i)),
                  t.hasCommittedMutations && n.setHasCommittedMutations();
              } else {
                if (!t.unknownDocument) return Pr();
                {
                  const e = ai.fromSegments(t.unknownDocument.path),
                    s = ku(t.unknownDocument.version);
                  n = Xs.newUnknownDocument(e, s);
                }
              }
              return (
                t.readTime &&
      ...
      class Bc extends Oc {
        ...
        applyChanges(s) {
          ...
          return (
            this.changes.forEach((e, t) => {
              var n = this.us.get(e);
              if (
                (o.push(this.os.removeEntry(s, e, n.readTime)),
                t.isValidDocument())
              ) {
                var r = Au(this.os.serializer, t);
                u = u.add(e.path.popLast());
                var i = wc(r);
                (a += i - n.size), o.push(this.os.addEntry(s, e, r));
              } else if (((a -= n.size), this.trackRemovals)) {
                const a = Au(
                  this.os.serializer,
                  t.convertToNoDocument(ni.min())
                );
                o.push(this.os.addEntry(s, e, a));
              }
            }),
            u.forEach((e) => {
              o.push(this.os.indexManager.addToCollectionParentIndex(s, e));
            }),
            o.push(this.os.updateMetadata(s, a)),
            bi.waitFor(o)
          );
        }
        getFromCache(e, t) {
          return this.os
            ...
            .next(
              (e) => (
                this.us.set(t, { size: e.size, readTime: e.document.readTime }),
                e.document
              )
            );
        }
        getAllFromCache(e, t) {
          return this.os.ss(e, t).next(
            ({ documents: n, rs: e }) => (
              e.forEach((e, t) => {
                this.us.set(e, { size: t, readTime: n.get(e).readTime });
              }),
              n
            )
          );
      ...
      function zc(e, t) {
        ...
        return (
          (i = Jr(n.length, r.length)),
          i ||
            ((i = Jr(n[n.length - 2], r[r.length - 2])),
            i || Jr(n[n.length - 1], r[r.length - 1]))
        );
      }
      class $c {
        constructor(e, t) {
      ...
      class Kc {
        ...
        getDocument(t, n) {
          ...
          return this.documentOverlayCache
            ...
            .next(
              (e) => (null !== r && ba(r.mutation, e, ws.empty(), ti.now()), e)
            );
        }
        getDocuments(t, e) {
          return this.remoteDocumentCache
            .getEntries(t, e)
            .next((e) =>
              this.getLocalViewOfDocuments(t, e, Jo()).next(() => e)
            );
        }
        getLocalViewOfDocuments(e, t, n = Jo()) {
          const r = Wo();
        ...
        computeViews(e, t, r, i) {
          ...
          return (
            t.forEach((e, t) => {
              const n = r.get(t.key);
              i.has(t.key) && (void 0 === n || n.mutation instanceof _a)
                ? (s = s.insert(t.key, t))
                : void 0 !== n
                ? (o.set(t.key, n.mutation.getFieldMask()),
                  ba(n.mutation, t, n.mutation.getFieldMask(), ti.now()))
                : o.set(t.key, ws.empty());
            }),
        ...
        recalculateAndSaveOverlays(s, o) {
          const a = Wo();
          let u = new fs((e, t) => e - t),
            c = Jo();
          return this.mutationQueue
            .getAllMutationBatchesAffectingDocumentKeys(s, o)
            .next((e) => {
              for (const r of e)
                r.keys().forEach((e) => {
                  var t,
            ...
            .next(() => {
              ...
              for (; t.hasNext(); ) {
                ...
                r.forEach((e) => {
                  var t;
                  c.has(e) ||
                    (null !== (t = va(o.get(e), a.get(e))) && i.set(e, t),
                    (c = c.add(e)));
                }),
        ...
        getNextDocuments(s, t, o, a) {
          return this.remoteDocumentCache
            .getAllFromCollectionGroup(s, t, o, a)
            .next((n) => {
              const e =
                0 < a - n.size
              ...
              return e.next((e) =>
                bi
                  ...
                  .next(() => this.computeViews(s, i, e, Jo()))
                  .next((e) => ({ batchId: r, changes: Ho(e) }))
              );
            });
        }
        getDocumentsMatchingDocumentQuery(e, t) {
          return this.getDocument(e, new ai(t)).next((e) => {
            let t = Qo();
          ...
          return this.indexManager.getCollectionParents(r, o).next((e) =>
            bi
              .forEach(e, (e) => {
                ...
                return this.getDocumentsMatchingCollectionQuery(r, n, s).next(
                  (e) => {
                    e.forEach((e, t) => {
                      a = a.insert(e, t);
                    });
        ...
        getDocumentsMatchingCollectionQuery(t, s, n) {
          ...
          return this.documentOverlayCache
            ...
            .next(
              (e) => (
                (o = e),
                this.remoteDocumentCache.getDocumentsMatchingQuery(t, s, n, o)
              )
            )
            .next((r) => {
              o.forEach((e, t) => {
                var n = t.getKey();
                null === r.get(n) &&
                  (r = r.insert(n, Xs.newInvalidDocument(n)));
              });
              let i = Qo();
              return (
                r.forEach((e, t) => {
                  var n = o.get(e);
                  void 0 !== n && ba(n.mutation, t, ws.empty(), ti.now()),
                    Uo(s, t) && (i = i.insert(e, t));
                }),
                i
              );
            });
      ...
      class Qc {
        ...
        getBundleMetadata(e, t) {
          return bi.resolve(this.cs.get(t));
        }
        saveBundleMetadata(e, t) {
          return (
            this.cs.set(t.id, {
        ...
        getNamedQuery(e, t) {
          return bi.resolve(this.hs.get(t));
        }
        saveNamedQuery(e, t) {
          return (
            this.hs.set(t.name, {
      ...
      class Hc {
        constructor() {
          (this.overlays = new fs(ai.comparator)), (this.ls = new Map());
        }
        getOverlay(e, t) {
          return bi.resolve(this.overlays.get(t));
        }
        getOverlays(e, t) {
          const n = Wo();
          return bi
        ...
        getOverlaysForCollectionGroup(t, e, n, r) {
          ...
          for (; s.hasNext(); ) {
            ...
            if (t.getKey().getCollectionGroup() === e && t.largestBatchId > n) {
              ...
              null === e && ((e = Wo()), (i = i.insert(t.largestBatchId, e))),
                e.set(t.getKey(), t);
            }
          }
          const o = Wo(),
        ...
        we(e, t, n) {
          ...
          let i = this.ls.get(t);
          void 0 === i && ((i = Jo()), this.ls.set(t, i)),
            this.ls.set(t, i.add(n.key));
        }
      }
      class Wc {
        constructor() {
          (this.fs = new ps(Xc.ds)), (this.ws = new ps(Xc._s));
        }
        isEmpty() {
      ...
      class Xc {
        ...
        static ds(e, t) {
          return ai.comparator(e.key, t.key) || Jr(e.As, t.As);
        }
        static _s(e, t) {
          return Jr(e.As, t.As) || ai.comparator(e.key, t.key);
        }
      }
      class Yc {
        constructor(e, t) {
          (this.indexManager = e),
            ...
            (this.mutationQueue = []),
            (this.vs = 1),
            (this.Rs = new ps(Xc.ds));
        }
        checkEmpty(e) {
          return bi.resolve(0 === this.mutationQueue.length);
        }
        addMutationBatch(e, t, n, r) {
          ...
          var s = new Ca(i, t, n, r);
          this.mutationQueue.push(s);
          for (const t of r)
            (this.Rs = this.Rs.add(new Xc(t.key, i))),
        ...
        getHighestUnacknowledgedBatchId() {
          return bi.resolve(0 === this.mutationQueue.length ? -1 : this.vs - 1);
        }
        getAllMutationBatches(e) {
          return bi.resolve(this.mutationQueue.slice());
        }
        getAllMutationBatchesAffectingDocumentKey(e, t) {
          const n = new Xc(t, 0),
            r = new Xc(t, Number.POSITIVE_INFINITY),
            i = [];
          return (
        ...
        getAllMutationBatchesAffectingDocumentKeys(e, t) {
          ...
          return (
            t.forEach((e) => {
              var t = new Xc(e, 0),
                n = new Xc(e, Number.POSITIVE_INFINITY);
              this.Rs.forEachInRange([t, n], (e) => {
                r = r.add(e.As);
              });
            }),
            bi.resolve(this.Vs(r))
          );
        }
        getAllMutationBatchesAffectingQuery(e, t) {
          const n = t.path,
          ...
          var s = new Xc(new ai(i), 0);
          let o = new ps(Jr);
          return (
            this.Rs.forEachWhile((e) => {
              var t = e.key.path;
              return (
                !!n.isPrefixOf(t) && (t.length === r && (o = o.add(e.As)), !0)
              );
            }, s),
            bi.resolve(this.Vs(o))
          );
        }
        Vs(e) {
          const n = [];
        ...
        removeMutationBatch(n, r) {
          Br(0 === this.Ss(r.batchId, "removed")), this.mutationQueue.shift();
          let i = this.Rs;
          return bi
            .forEach(r.mutations, (e) => {
              var t = new Xc(e.key, r.batchId);
              return (
                (i = i.delete(t)),
        ...
        containsKey(e, t) {
          ...
          return bi.resolve(t.isEqual(n && n.key));
        }
        performConsistencyCheck(e) {
          return this.mutationQueue.length, bi.resolve();
        }
        Ss(e, t) {
          return this.bs(e);
        }
      ...
      class Jc {
        constructor(e) {
          (this.Ds = e), (this.docs = new fs(ai.comparator)), (this.size = 0);
        }
        setIndexManager(e) {
          this.indexManager = e;
        }
        ...
        getEntry(e, t) {
          ...
          return bi.resolve(
            n ? n.document.mutableCopy() : Xs.newInvalidDocument(t)
          );
        }
        getEntries(e, t) {
          let n = $o;
          return (
            t.forEach((e) => {
              ...
              n = n.insert(
                e,
                t ? t.document.mutableCopy() : Xs.newInvalidDocument(e)
              );
            }),
            bi.resolve(n)
          );
        ...
        Cs(e, t) {
          return bi.forEach(this.docs, (e) => t(e));
        }
        newChangeBuffer(e) {
          return new Zc(this);
        }
        getSize(e) {
          return bi.resolve(this.size);
        }
      }
      class Zc extends Oc {
        constructor(e) {
        ...
        applyChanges(n) {
          ...
          return (
            this.changes.forEach((e, t) => {
              t.isValidDocument()
                ? r.push(this.os.addEntry(n, t))
                : this.os.removeEntry(e);
            }),
            bi.waitFor(r)
          );
        }
      ...
      class eh {
        constructor(e) {
          (this.persistence = e),
            (this.xs = new zo((e) => Io(e), Eo)),
            (this.lastRemoteSnapshotVersion = ni.min()),
        ...
        forEachTarget(e, n) {
          return this.xs.forEach((e, t) => n(t)), bi.resolve();
        }
        getLastRemoteSnapshotVersion(e) {
          return bi.resolve(this.lastRemoteSnapshotVersion);
        }
        getHighestSequenceNumber(e) {
          return bi.resolve(this.Ns);
        }
        allocateTargetId(e) {
          return (
            (this.highestTargetId = this.Ms.next()),
            bi.resolve(this.highestTargetId)
          );
        }
        ...
        Fn(e) {
          ...
          t > this.highestTargetId &&
            ((this.Ms = new Sc(t)), (this.highestTargetId = t)),
            e.sequenceNumber > this.Ns && (this.Ns = e.sequenceNumber);
        }
        addTargetData(e, t) {
          return this.Fn(t), (this.targetCount += 1), bi.resolve();
        }
        updateTargetData(e, t) {
          return this.Fn(t), bi.resolve();
        }
          ...
          return (
            this.xs.forEach((e, t) => {
              t.sequenceNumber <= r &&
                ...
                (this.xs.delete(e),
                o.push(this.removeMatchingKeysForTargetId(n, t.targetId)),
                s++);
            }),
            bi.waitFor(o).next(() => s)
          );
        ...
        getTargetCount(e) {
          return bi.resolve(this.targetCount);
        }
        getTargetData(e, t) {
        ...
        addMatchingKeys(e, t, n) {
          return this.ks.gs(t, n), bi.resolve();
        }
        ...
        removeMatchingKeysForTargetId(e, t) {
          return this.ks.Is(t), bi.resolve();
        }
        getMatchingKeysForTargetId(e, t) {
          var n = this.ks.Es(t);
          return bi.resolve(n);
        ...
        containsKey(e, t) {
          return bi.resolve(this.ks.containsKey(t));
        }
      }
      class th {
        constructor(e, t) {
          (this.$s = {}),
            ...
            (this.remoteDocumentCache =
              ((e = (e) => this.referenceDelegate.Ls(e)), new Jc(e))),
            (this.serializer = new Du(t)),
            (this.qs = new Qc(this.serializer));
        }
        start() {
        ...
        getMutationQueue(e, t) {
          ...
          return (
            n ||
              ((n = new Yc(t, this.referenceDelegate)),
              (this.$s[e.toKey()] = n)),
            n
          );
        }
        ...
        Gs(t, n) {
          return bi.or(
            Object.values(this.$s).map((e) => () => e.containsKey(t, n))
          );
        }
      }
      class nh extends vi {
      ...
      class rh {
        constructor(e) {
          (this.persistence = e), (this.Qs = new Wc()), (this.js = null);
        }
        static zs(e) {
          return new rh(e);
        }
        ...
        removeReference(e, t, n) {
          return (
            ...
            this.Ws.add(n.toString()),
            bi.resolve()
          );
        }
        markPotentiallyOrphaned(e, t) {
          return this.Ws.add(t.toString()), bi.resolve();
        }
        removeTarget(e, t) {
        ...
        Hs(e, t) {
          return bi.or([
            () => bi.resolve(this.Qs.containsKey(t)),
      ...
      class ih {
        ...
        O(t, e, n, r) {
          ...
          n < 1 &&
            ...
            s
              ...
              .createIndex("userMutationsIndex", Bi, { unique: !0 }),
          ...
          return (
            ...
            n < 5 && 5 <= r && (o = o.next(() => this.Ys(i))),
            n < 6 &&
              6 <= r &&
              (o = o.next(
                () => (t.createObjectStore("remoteDocumentGlobal"), this.Xs(i))
              )),
            n < 7 && 7 <= r && (o = o.next(() => this.Zs(i))),
            n < 8 && 8 <= r && (o = o.next(() => this.ti(t, i))),
            n < 9 &&
              9 <= r &&
              (o = o.next(() => {
                var e;
            ...
            n < 12 &&
              ...
              (o = o.next(() => {
                !(function () {
                  ...
                  e.createIndex("collectionPathOverlayIndex", ts, {
                    unique: !1,
                  }),
                    e.createIndex("collectionGroupOverlayIndex", ns, {
                      unique: !1,
                    });
                })();
              })),
              ...
              (o = o
                .next(() =>
                  (function () {
                    ...
                    e.createIndex("documentKeyIndex", zi),
                      e.createIndex("collectionGroupIndex", $i);
                  })()
                )
                .next(() => this.ni(t, i))
                .next(() => t.deleteObjectStore("remoteDocuments"))),
            n < 14 && 14 <= r && (o = o.next(() => this.si(t, i))),
            n < 15 &&
              15 <= r &&
              (o = o.next(() =>
                (function (e) {
                  e
                    ...
                    e
                      .createObjectStore("indexState", { keyPath: Xi })
                      .createIndex("sequenceNumberIndex", Yi, { unique: !1 }),
                    e
                      .createObjectStore("indexEntries", { keyPath: Ji })
                      .createIndex("documentKeyIndex", Zi, { unique: !1 });
                })(t)
              )),
            o
          );
        ...
        Ys(r) {
          ...
          return e.j().next((e) =>
            bi.forEach(e, (n) => {
              ...
              return t.j("userMutationsIndex", e).next((e) =>
                bi.forEach(e, (e) => {
                  Br(e.userId === n.userId);
        ...
        Zs(e) {
          const o = e.store("targetDocuments"),
        ...
        ti(e, t) {
          e.createObjectStore("collectionParents", { keyPath: Wi });
          const n = t.store("collectionParents"),
            ...
            i = (e) => {
              if (r.add(e)) {
                const t = e.lastSegment(),
                  r = e.popLast();
                return n.put({ collectionId: t, parent: Oi(r) });
              }
            };
          return t
            .store("remoteDocuments")
            ...
            .next(() =>
              t.store("documentMutations").X({ Y: !0 }, ([, e], t) => {
                const n = Pi(e);
                return i(n.popLast());
              })
            );
        ...
        ei(e) {
          ...
          return r.X((e, t) => {
            var n = Mu(t),
              n = Fu(this.serializer, n);
            return r.put(n);
          });
        }
        ni(e, s) {
          const t = s.store("remoteDocuments"),
            o = [];
          return t
            .X((e, t) => {
              const n = s.store("remoteDocumentsV14"),
                r = (
                  (i = t).document
                    ? new ai(ii.fromString(i.document.name).popFirst(5))
                    : i.noDocument
                    ? ai.fromSegments(i.noDocument.path)
                    : i.unknownDocument
                    ? ai.fromSegments(i.unknownDocument.path)
                    : Pr()
                ).path.toArray();
              var i = {
        ...
        si(e, s) {
          const t = s.store("mutations"),
            o = Pc(this.serializer),
            a = new th(rh.zs, this.serializer.fe);
          return t.j().next((e) => {
            const r = new Map();
            return (
              e.forEach((e) => {
                var t;
                let n =
                  null !== (t = r.get(e.userId)) && void 0 !== t ? t : Jo();
                Ru(this.serializer, e)
                  .keys()
                  .forEach((e) => (n = n.add(e))),
                  r.set(e.userId, n);
              }),
              bi.forEach(r, (e, t) => {
                var n = new Nr(t),
                  r = ju.de(this.serializer, n),
                  i = a.getIndexManager(n),
                  n = bc.de(n, this.serializer, i, a.referenceDelegate);
                return new Kc(o, n, r, i)
      ...
      function sh(e) {
        e
          .createObjectStore("targetDocuments", { keyPath: Qi })
          .createIndex("documentTargetsIndex", Hi, { unique: !0 }),
          e
            .createObjectStore("targets", { keyPath: "targetId" })
            .createIndex("queryTargetsIndex", Ki, { unique: !0 }),
      ...
      class ah {
        constructor(e, t, n, r, i, s, o, a, u, c, h = 15) {
          if (
          ...
          (this.referenceDelegate = new Fc(this, r)),
            (this.di = t + "main"),
            (this.serializer = new Du(a)),
            (this.wi = new Ei(this.di, this.ui, new ih(this.serializer))),
            (this.Bs = new xc(this.referenceDelegate, this.serializer)),
            (this.remoteDocumentCache = Pc(this.serializer)),
            (this.qs = new Bu()),
          ...
          return this.mi()
            .then(() => {
              if (!this.isPrimary && !this.allowTabSynchronization)
                throw new Ur(qr.FAILED_PRECONDITION, oh);
              return (
                this.gi(),
                this.yi(),
                this.pi(),
        ...
        mi() {
          return this.runTransaction(
            ...
            .then((e) => {
              this.isPrimary !== e &&
                this.ii.enqueueRetryable(() => this.fi(e)),
                (this.isPrimary = e);
            });
        }
        Ti(e) {
        ...
        async bi() {
          if (this.isPrimary && !this.Vi(this.li, 18e5)) {
            ...
            if (this._i)
              for (const t of e) this._i.removeItem(this.Di(t.clientId));
          }
        }
        pi() {
          this.hi = this.ii.enqueueAfterDelay(
        ...
        async shutdown() {
          (this.Fs = !1),
            ...
            this.Ni(),
            this.ki(),
            await this.wi.runTransaction(
              "shutdown",
              "readwrite",
              ["owner", "clientMetadata"],
              (e) => {
                const t = new us(e, Ri.ct);
        ...
        Si(e, t) {
          return e.filter(
            (e) => this.Vi(e.updateTimeMs, t) && !this.Ci(e.clientId)
          );
        }
        $i() {
        ...
        getMutationQueue(e, t) {
          return bc.de(e, this.serializer, t, this.referenceDelegate);
        }
        getTargetCache() {
          return this.Bs;
        }
        ...
        getIndexManager(e) {
          return new hc(e, this.serializer.fe.databaseId);
        }
        getDocumentOverlayCache(e) {
          return ju.de(this.serializer, e);
        }
        getBundleCache() {
          return this.qs;
        }
        runTransaction(t, n, r) {
          ...
          return this.wi
            .runTransaction(
              ...
              e,
              (e) => (
                (s = new us(e, this.Os ? this.Os.next() : Ri.ct)),
                "readwrite-primary" === n
                  ? this.Ti(s)
                      .next((e) => !!e || this.Ei(s))
                      .next((e) => {
                        if (!e)
                          throw (
                            ...
                            (this.isPrimary = !1),
                            this.ii.enqueueRetryable(() => this.fi(!1)),
                            new Ur(qr.FAILED_PRECONDITION, yi))
                          );
                        return r(s);
                      })
        ...
        Ai(e) {
          ...
          return t
            ...
            .next((e) =>
              this.Ri(e)
                ? (Fr("IndexedDbPersistence", "Releasing primary lease."),
                  t.delete("owner"))
                : bi.resolve()
            );
        }
        Vi(e, t) {
          ...
          return !(
            e < n - t ||
            (n < e &&
              (Lr(`Detected an update time that is in the future: ${e} > ${n}`),
              1))
          );
        }
        gi() {
        ...
        Ci(e) {
          ...
          try {
            ...
            return (
              Lr("IndexedDbPersistence", "Failed to get zombied client id.", e),
              !1
            );
          }
        }
        xi() {
          if (this._i)
            try {
              ...
              Lr("Failed to set zombie client id.", e);
            }
        }
        Mi() {
          if (this._i)
      ...
      class dh {
        ...
        getDocumentsMatchingQuery(t, n, r, i) {
          return this.Ki(t, n)
            .next((e) => e || this.Gi(t, n, i, r))
            .next((e) => e || this.Qi(t, n));
        }
        Ki(i, s) {
          if (No(s)) return bi.resolve(null);
          let t = Lo(s);
          return this.indexManager.getIndexType(i, t).next((e) =>
            0 === e
              ...
              : (null !== s.limit &&
                  1 === e &&
                  ((s = Vo(s, null, "F")), (t = Lo(s))),
                this.indexManager.getDocumentsMatchingTarget(i, t).next((e) => {
                  const r = Jo(...e);
                  return this.Ui.getDocuments(i, r).next((n) =>
                    this.indexManager.getMinOffset(i, t).next((e) => {
                      var t = this.ji(s, n);
                      return this.zi(s, t, r, e.readTime)
                        ? this.Ki(i, Vo(s, null, "F"))
                        : this.Wi(i, t, s, e);
                    })
                  );
                }))
        ...
        Gi(n, r, i, s) {
          return No(r) || s.isEqual(ni.min())
            ? this.Qi(n, r)
            : this.Ui.getDocuments(n, i).next((e) => {
                var t = this.ji(r, e);
                return this.zi(r, t, i, s)
                  ? this.Qi(n, r)
                  : (Mr() <= l.DEBUG &&
                      Fr(
                        "QueryEngine",
        ...
        Qi(e, t) {
          return (
            ...
            this.Ui.getDocumentsMatchingQuery(e, t, mi.min())
          );
        }
        Wi(e, n, t, r) {
          return this.Ui.getDocumentsMatchingQuery(e, t, r).next(
            (t) => (
              n.forEach((e) => {
                t = t.insert(e.key, e);
              }),
      ...
      async function mh(e, t) {
        ...
        return o.persistence.runTransaction(
          ...
          (i) => {
            let s;
            return o.mutationQueue
              .getAllMutationBatches(i)
              .next(
                (e) => (
                  (s = e), o.tr(t), o.mutationQueue.getAllMutationBatches(i)
                )
              )
              .next((e) => {
                const t = [],
      ...
      function yh(e, c) {
        ...
        return h.persistence
          .runTransaction("Apply remote event", "readwrite-primary", (a) => {
            const e = h.Zi.newChangeBuffer({ trackRemovals: !0 });
            d = h.Ji;
            const u = [];
            c.targetChanges.forEach((t, n) => {
              ...
              if (r) {
                u.push(
                  h.Bs.removeMatchingKeys(a, t.removedDocuments, n).next(() =>
                    h.Bs.addMatchingKeys(a, t.addedDocuments, n)
                  )
                );
                let e = r.withSequenceNumber(a.currentSequenceNumber);
                var i, s, o;
                null !== c.targetMismatches.get(n)
                  ? (e = e
                      .withResumeToken(Is.EMPTY_BYTE_STRING, ni.min())
                      .withLastLimboFreeSnapshotVersion(ni.min()))
                  ...
                  (0 !== i.resumeToken.approximateByteSize() &&
                    ...
                    u.push(h.Bs.updateTargetData(a, e));
              }
            });
            let t = $o,
              n = Jo();
            if (
              (c.documentUpdates.forEach((e) => {
                c.resolvedLimboDocuments.has(e) &&
                  u.push(
                    h.persistence.referenceDelegate.updateLimboDocument(a, e)
                  );
              }),
              u.push(
                vh(a, e, c.documentUpdates).next((e) => {
                  (t = e.nr), (n = e.sr);
                })
              ),
              !l.isEqual(ni.min()))
            ) {
              const c = h.Bs.getLastRemoteSnapshotVersion(a).next((e) =>
                h.Bs.setTargetsMetadata(a, a.currentSequenceNumber, l)
              );
              u.push(c);
            }
            return bi
              .waitFor(u)
              .next(() => e.apply(a))
              .next(() => h.localDocuments.getLocalViewOfDocuments(a, t, n))
              .next(() => t);
          })
          .then((e) => ((h.Ji = d), e));
      }
        ...
        return (
          ...
          s.getEntries(e, n).next((r) => {
            ...
            return (
              t.forEach((e, t) => {
                const n = r.get(e);
                t.isFoundDocument() !== n.isFoundDocument() && (o = o.add(e)),
                  t.isNoDocument() && t.version.isEqual(ni.min())
      ...
      function wh(e, r) {
        ...
        return i.persistence
          .runTransaction("Allocate target", "readwrite", (t) => {
            let n;
            return i.Bs.getTargetData(t, r).next((e) =>
              e
                ? ((n = e), bi.resolve(n))
                : i.Bs.allocateTargetId(t).next(
                    (e) => (
                      (n = new xu(
                        r,
                        e,
                      ...
                      i.Bs.addTargetData(t, n).next(() => n)
                    )
                  )
            );
          })
          .then((e) => {
            var t = i.Ji.get(e.targetId);
            return (
              (null === t ||
                0 < e.snapshotVersion.compareTo(t.snapshotVersion)) &&
                ((i.Ji = i.Ji.insert(e.targetId, e)), i.Yi.set(r, e.targetId)),
              e
            );
          });
      }
      ...
      function Ih(e, n, r) {
        ...
        return i.persistence.runTransaction("Execute query", "readonly", (t) =>
          (function (e, t, n) {
            ...
            .next((e) => {
              if (e)
                return (
                  ...
                  i.Bs.getMatchingKeysForTargetId(t, e.targetId).next((e) => {
                    o = e;
                  })
                );
            })
            ...
            .next((e) => (Th(i, jo(n), e), { documents: e, ir: o }))
        );
      }
      function Eh(e, t) {
        const n = e,
        ...
        return i
          ...
          : n.persistence.runTransaction("Get target data", "readonly", (e) =>
              r.le(e, t).next((e) => (e ? e.target : null))
            );
      }
      function _h(e, t) {
        const n = e,
        ...
        return n.persistence
          .runTransaction("Get new document changes", "readonly", (e) =>
            n.Zi.getAllFromCollectionGroup(
              e,
              t,
              fi(r, -1),
              Number.MAX_SAFE_INTEGER
        ...
        static ar(e, t, n) {
          ...
          return (
            s &&
              ...
              s && (i = new Ur(r.error.code, r.error.message))),
            s
              ? new Ah(e, t, r.state, i)
              : (Lr(
                  "SharedClientState",
        ...
        static ar(e, t) {
          ...
          return (
            i &&
              ...
              i && (r = new Ur(n.error.code, n.error.message))),
            i
              ? new Ch(e, n.state, r)
              : (Lr(
                  "SharedClientState",
      ...
      class Nh {
        ...
        static ar(e, t) {
          ...
          for (let s = 0; r && s < n.activeTargetIds.length; ++s)
            (r = Li(n.activeTargetIds[s])), (i = i.add(n.activeTargetIds[s]));
          return r
            ? new Nh(e, i)
            : (Lr(
                "SharedClientState",
      ...
      class kh {
        ...
        static ar(e) {
          ...
          return "object" == typeof t &&
            ...
            ? new kh(t.clientId, t.onlineState)
            : (Lr("SharedClientState", `Failed to parse online state: ${e}`),
              null);
        }
      }
      class Rh {
        constructor() {
          this.activeTargetIds = Zo;
        }
        lr(e) {
      ...
      class Mh {
        constructor(e, t, n, r, i) {
          ...
          (this.storage = this.window.localStorage),
            (this.currentUser = i),
            (this.pr = Sh(this.persistenceKey, this.wr)),
            (this.Ir = `firestore_sequence_number_${this.persistenceKey}`),
            (this.gr = this.gr.insert(this.wr, new Rh())),
            (this.Tr = new RegExp(`^firestore_clients_${s}_([^_]*)$`)),
            (this.Er = new RegExp(
              `^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`
            )),
            (this.Ar = new RegExp(`^firestore_targets_${s}_(\\d+)$`)),
            (this.vr = `firestore_online_state_${this.persistenceKey}`),
            (this.Rr = `firestore_bundle_loaded_v2_${this.persistenceKey}`),
        ...
        async start() {
          ...
          this.Pr();
          const n = this.storage.getItem(this.vr);
          if (n) {
            const e = this.br(n);
            e && this.Vr(e);
          }
        ...
        addLocalQueryTarget(e) {
          ...
          return (
            this.isActiveQueryTarget(e) &&
              (!(n = this.storage.getItem(Dh(this.persistenceKey, e))) ||
                ((n = Ch.ar(e, n)) && (t = n.state))),
            this.Nr.lr(e),
            this.Pr(),
            t
          );
        ...
        shutdown() {
          this.started &&
            (this.window.removeEventListener("storage", this._r),
        ...
        mr(e) {
          ...
          i.storageArea === this.storage &&
            (Fr("SharedClientState", "EVENT", i.key, i.newValue),
            i.key !== this.pr
              ? this.ii.enqueueRetryable(async () => {
                  if (this.started) {
                    if (null !== i.key)
                      if (this.Tr.test(i.key)) {
                        if (null == i.newValue) {
                          var e = this.Or(i.key);
                          return this.Fr(e, null);
                        }
                        e = this.Br(i.key, i.newValue);
                        if (e) return this.Fr(e.clientId, e);
                      } else if (this.Er.test(i.key)) {
                        if (null !== i.newValue) {
                          var t = this.Lr(i.key, i.newValue);
                          if (t) return this.qr(t);
                        }
                      } else if (this.Ar.test(i.key)) {
                        if (null !== i.newValue) {
                          t = this.Ur(i.key, i.newValue);
                          if (t) return this.Kr(t);
                        }
                      } else if (i.key === this.vr) {
                        if (null !== i.newValue) {
                          var n = this.br(i.newValue);
                          if (n) return this.Vr(n);
                        }
                      } else if (i.key === this.Ir) {
                        n = (function (e) {
                          let t = Ri.ct;
                          if (null != e)
                            try {
                              var n = JSON.parse(e);
                              Br("number" == typeof n), (t = n);
                            } catch (e) {
                              Lr(
                                "SharedClientState",
                        ...
                        n !== Ri.ct && this.sequenceNumberHandler(n);
                      } else if (i.key === this.Rr) {
                        const r = this.Gr(i.newValue);
        ...
        Mr(e) {
          var t = { clientId: this.wr, onlineState: e };
      ...
      class Fh {
        ...
        start() {
          return (this.Hr = new Rh()), Promise.resolve();
        }
        handleUserChange(e, t, n) {}
        setOnlineState(e) {}
        shutdown() {}
      ...
      function Ph() {
        return (
          null === Vh
            ? (Vh = 268435456 + Math.round(2147483648 * Math.random()))
            : Vh++,
          "0x" + Vh.toString(16)
        );
      }
      ...
      class jh extends class {
        ...
        Io(t, e, n, r, i) {
          const s = Ph(),
            o = this.To(t, e);
          Fr("RestConnection", `Sending RPC '${t}' ${s}:`, o, n);
          var a = {};
          return (
            this.Eo(a, r, i),
            this.Ao(t, o, a, n).then(
              (e) => (Fr("RestConnection", `Received RPC '${t}' ${s}: `, e), e),
              (e) => {
                throw (
                  (Or(
                    "RestConnection",
        ...
        Eo(n, e, t) {
          (n["X-Goog-Api-Client"] = "gl-js/ fire/" + kr),
                ...
                try {
                  switch (o.getLastErrorCode()) {
                    case wr.NO_ERROR:
                      ...
                      Fr(
                        Uh,
                        `XHR for RPC '${a}' ${u} received:`,
                        JSON.stringify(e)
                      ),
                        i(e);
                      break;
                    case wr.TIMEOUT:
                      Fr(Uh, `RPC '${a}' ${u} timed out`),
                        s(new Ur(qr.DEADLINE_EXCEEDED, "Request time out"));
                      break;
                    case wr.HTTP_ERROR:
                      var t = o.getStatus();
                      if (
                        ...
                        if (n && n.status && n.message) {
                          const a =
                            ...
                            0 <= Object.values(qr).indexOf(r) ? r : qr.UNKNOWN);
                          s(new Ur(a, n.message));
                        } else
                          s(
                            new Ur(
                              qr.UNKNOWN,
                      ...
                      } else s(new Ur(qr.UNAVAILABLE, "Connection failed."));
                      break;
                    default:
                      Pr();
                  }
                } finally {
                  Fr(Uh, `RPC '${a}' ${u} completed.`);
                }
                var r;
              });
            var e = JSON.stringify(r);
            Fr(Uh, `RPC '${a}' ${u} sending request:`, r),
        ...
        Ro(i, e, t) {
          ...
          void 0 !== u && (a.longPollingTimeout = Math.round(1e3 * u)),
            this.useFetchStreams && (a.xmlHttpFactory = new Tr({})),
            this.Eo(a.initMessageHeaders, e, t),
            (a.encodeInitMessageHeaders = !0);
          var c = n.join("");
          Fr(Uh, `Creating RPC '${i}' stream ${s}: ${c}`, a);
          const h = r.createWebChannel(c, a);
          let l = !1,
            d = !1;
          const f = new qh({
              ro: (e) => {
                d
                  ...
                  : (l ||
                      (Fr(Uh, `Opening RPC '${i}' stream ${s} transport.`),
                      h.open(),
                      (l = !0)),
                    Fr(Uh, `RPC '${i}' stream ${s} sending:`, e),
                    h.send(e));
              },
              oo: () => h.close(),
            }),
          ...
          return (
            g(h, Sr.EventType.OPEN, () => {
              d || Fr(Uh, `RPC '${i}' stream ${s} transport opened.`);
            }),
            g(h, Sr.EventType.CLOSE, () => {
              d ||
                ((d = !0),
                Fr(Uh, `RPC '${i}' stream ${s} transport closed`),
                f.wo());
            }),
            g(h, Sr.EventType.ERROR, (e) => {
              d ||
                ((d = !0),
                Or(Uh, `RPC '${i}' stream ${s} transport errored:`, e),
                f.wo(
                  new Ur(qr.UNAVAILABLE, "The operation could not be completed")
                ));
            }),
            g(h, Sr.EventType.MESSAGE, (n) => {
              if (!d) {
                ...
                if (r) {
                  Fr(Uh, `RPC '${i}' stream ${s} received error:`, r);
                  const n = r.status;
                  let e = (function (e) {
                      var t = yr[e];
                      if (void 0 !== t) return Fa(t);
                    })(n),
                    t = r.message;
                  void 0 === e &&
                    ((e = qr.INTERNAL),
                    ...
                    f.wo(new Ur(e, t)),
                    h.close();
                } else Fr(Uh, `RPC '${i}' stream ${s} received:`, e), f._o(e);
              }
            }),
            g(o, Ir.STAT_EVENT, (e) => {
              e.stat === Er
                ? Fr(Uh, `RPC '${i}' stream ${s} detected buffering proxy`)
                : e.stat === _r &&
                  Fr(Uh, `RPC '${i}' stream ${s} detected no buffering proxy`);
            }),
            setTimeout(() => {
              f.fo();
            }, 0),
      ...
      class Kh {
        ...
        No(e) {
          this.cancel();
          var t = Math.floor(this.So + this.ko()),
            n = Math.max(0, Date.now() - this.Co),
            r = Math.max(0, t - n);
          0 < r &&
            Fr(
              "ExponentialBackoff",
              `Backing off for ${r} ms (base delay: ${this.So} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`
            ),
      ...
      class Qh {
        ...
        jo() {
          this.Ko() &&
            null === this.Bo &&
            (this.Bo = this.ii.enqueueAfterDelay(this.$o, 6e4, () =>
              this.zo()
            ));
        }
        Wo(e) {
        ...
        async close(e, t) {
          this.Ho(),
            ...
            4 !== e
              ? this.qo.reset()
              : t && t.code === qr.RESOURCE_EXHAUSTED
              ? (Lr(t.toString()),
                Lr(
        ...
        tu(e) {
          return (
            Fr("PersistentStream", `close with error: ${e}`),
            (this.stream = null),
            this.close(4, e)
          );
        }
      ...
      class Hh extends Qh {
              ...
              if ("targetChange" in t) {
                ...
                var r =
                  ...
                  s =
                    ...
                    e.useProto3Json
                      ? (Br(void 0 === f || "string" == typeof f),
                        Is.fromBase64String(f || ""))
                      : (Br(void 0 === f || f instanceof Uint8Array),
                        Is.fromUint8Array(f || new Uint8Array()))),
                  o = t.targetChange.cause,
                  a =
                    o &&
                    ((a = void 0 === (f = o).code ? qr.UNKNOWN : Fa(f.code)),
                    new Ur(a, f.message || ""));
                n = new Qa(r, i, s, a || null);
              } else if ("documentChange" in t) {
                t.documentChange;
                var u = t.documentChange;
                u.document, u.document.name, u.document.updateTime;
                var s = cu(e, u.document.name),
                  a = su(u.document.updateTime),
                  c = u.document.createTime
                    ? su(u.document.createTime)
                    : ni.min(),
                  h = new Ws({ mapValue: { fields: u.document.fields } }),
                  c = Xs.newFoundDocument(s, a, c, h),
                  h = u.targetIds || [],
                ...
                h.document;
                (u = cu(e, h.document)),
                  (c = h.readTime ? su(h.readTime) : ni.min()),
                  (c = Xs.newNoDocument(u, c)),
        ...
        su(e) {
          const t = {};
          (t.database = du(this.serializer)),
            (t.addTarget = (function (e, t) {
              let n;
              const r = t.target;
              if (
                ((n = _o(r) ? { documents: vu(e, r) } : { query: wu(e, r) }),
          ...
          var n,
            ...
            r =
              ...
              (r = (function () {
                ...
                ? null
                : { "goog-listen-tags": r });
          r && (t.labels = r), this.Wo(t);
        }
        iu(e) {
          const t = {};
          (t.database = du(this.serializer)), (t.removeTarget = e), this.Wo(t);
        }
      }
      class Wh extends Qh {
        constructor(e, t, n, r, i, s) {
        ...
        onMessage(e) {
                  ...
                  ? (Br(void 0 !== i),
                    r.map((e) =>
                      (function (e, t) {
                        ...
                        return (
                          n.isEqual(ni.min()) && (n = su(t)),
                          new ga(n, e.transformResults || [])
                        );
                      })(e, i)
                    ))
                  : []),
          ...
          var r, i;
          return (
            Br(!e.writeResults || 0 === e.writeResults.length),
            (this.ru = !0),
            this.listener.au()
          );
        }
        hu() {
          const e = {};
          (e.database = du(this.serializer)), this.Wo(e);
        }
        uu(e) {
          var t = {
        ...
        Io(n, r, i) {
          return (
            ...
            Promise.all([
              ...
              .then(([e, t]) => this.connection.Io(n, r, i, e, t))
              .catch((e) => {
                throw "FirebaseError" === e.name
                  ? (e.code === qr.UNAUTHENTICATED &&
                      (this.authCredentials.invalidateToken(),
                      this.appCheckCredentials.invalidateToken()),
                    e)
                  : new Ur(qr.UNKNOWN, e.toString());
              })
          );
        }
        vo(n, r, i, s) {
          return (
            ...
            Promise.all([
              ...
              .then(([e, t]) => this.connection.vo(n, r, i, e, t, s))
              .catch((e) => {
                throw "FirebaseError" === e.name
                  ? (e.code === qr.UNAUTHENTICATED &&
                      (this.authCredentials.invalidateToken(),
      ...
      class Yh {
        ...
        pu(e) {
          ...
          this.mu ? (Lr(t), (this.mu = !1)) : Fr("OnlineStateTracker", t);
        }
        Tu() {
      ...
      async function Zh(e) {
        if (al(e)) for (const t of e.Ru) await t(!0);
      }
      async function el(e) {
      ...
      function tl(e, t) {
        const n = e;
        n.Au.has(t.targetId) ||
          (n.Au.set(t.targetId, t), ol(n) ? sl(n) : pl(n).Ko() && rl(n, t));
      }
      function nl(e, t) {
        const n = e,
          r = pl(n);
        n.Au.delete(t),
          r.Ko() && il(n, t),
          0 === n.Au.size && (r.Ko() ? r.jo() : al(n) && n.bu.set("Unknown"));
      }
      function rl(e, t) {
        var n;
        e.Vu.qt(t.targetId),
          (0 < t.resumeToken.approximateByteSize() ||
            0 < t.snapshotVersion.compareTo(ni.min())) &&
      ...
      function ol(e) {
        return al(e) && !pl(e).Uo() && 0 < e.Au.size;
      }
      function al(e) {
        return 0 === e.vu.size;
      }
      ...
      async function cl(e, t, n) {
        ...
        e.vu.add(1),
          ...
          e.asyncQueue.enqueueRetryable(async () => {
            Fr("RemoteStore", "Retrying IndexedDB access"),
              await n(),
              e.vu.delete(1),
              await Zh(e);
          });
      ...
      async function ll(e) {
        const t = e,
          n = yl(t);
        let r = 0 < t.Eu.length ? t.Eu[t.Eu.length - 1].batchId : -1;
        for (; al((i = t)) && i.Eu.length < 10; )
          try {
      ...
      function dl(e) {
        return al(e) && !yl(e).Uo() && 0 < e.Eu.length;
      }
      function fl(e) {
        yl(e).start();
      }
      async function gl(e, t) {
        ...
        n.asyncQueue.verifyOperationInProgress(),
          Fr("RemoteStore", "RemoteStore received new credentials");
        var r = al(n);
        n.vu.add(3),
          await el(n),
          r && n.bu.set("Unknown"),
      ...
      async function ml(e, t) {
        const n = e;
        t
          ? (n.vu.delete(2), await Zh(n))
          : (n.vu.add(2), await el(n), n.bu.set("Unknown"));
      }
      function pl(t) {
        return (
          t.Su ||
            ((t.Su = (function (e, t, n) {
              ...
              ao: async function (e, t) {
                ul(e), ol(e) ? (e.bu.Iu(t), sl(e)) : e.bu.set("Unknown");
              }.bind(null, t),
              nu: async function (e, r, t) {
                if (
                  (e.bu.set("Online"),
                  r instanceof Qa && 2 === r.state && r.cause)
                )
                  try {
                    await (async function (e) {
                      var t = r.cause;
                  ...
                  try {
                          ...
                          e.targetMismatches.forEach((e, t) => {
                            ...
                            n &&
                              (i.Au.set(
                                e,
                                n.withResumeToken(
                                  Is.EMPTY_BYTE_STRING,
                                  n.snapshotVersion
                                )
                              ),
                              il(i, e),
                              (r = new xu(n.target, e, t, n.sequenceNumber)),
                              rl(i, r));
                          }),
                    ...
                    Fr("RemoteStore", "Failed to raise snapshot:", r),
                      await cl(e, r);
                  }
              }.bind(null, t),
            })),
            t.Ru.push(async (e) => {
              e
                ? (t.Su.Qo(), ol(t) ? sl(t) : t.bu.set("Unknown"))
                : (await t.Su.stop(), ul(t));
            })),
          t.Su
        );
      }
        ...
        return (
          t.Du ||
            ((t.Du = (function (e, t, n) {
              ...
              cu: async function (e, t, n) {
                const r = e.Eu.shift(),
                  i = Na.from(r, t, n);
                await hl(e, () => e.remoteSyncer.applySuccessfulWrite(i)),
                  await ll(e);
              }.bind(null, t),
            })),
            t.Ru.push(async (e) => {
        ...
        cancel(e) {
          null !== this.timerHandle &&
            ...
            this.deferred.reject(
              new Ur(qr.CANCELLED, "Operation cancelled" + (e ? ": " + e : ""))
            ));
        }
        handleDelayElapsed() {
      ...
      function wl(e, t) {
        if ((Lr("AsyncQueue", `${t}: ${e}`), Si(e)))
          return new Ur(qr.UNAVAILABLE, `${t}: ${e}`);
        throw e;
      }
      class bl {
        constructor(n) {
          (this.comparator = n
            ? (e, t) => n(e, t) || ai.comparator(e.key, t.key)
            : (e, t) => ai.comparator(e.key, t.key)),
            (this.keyedMap = Qo()),
            (this.sortedSet = new fs(this.comparator));
        }
        static emptySet(e) {
      ...
      async function Sl(e, t) {
        ...
        if ((s || ((i = !0), (s = new _l())), i))
          try {
            ...
            const n = wl(e, `Initialization of query '${qo(t.query)}' failed`);
      ...
      class Al {
        ...
        $u(e) {
          ...
          return (
            this.Fu
              ? this.Lu(e) && (this.Ou.next(e), (t = !0))
              : this.qu(e, this.onlineState) && (this.Uu(e), (t = !0)),
            (this.Bu = e),
            t
          );
        }
        ...
        qu(e, t) {
          return (
            !e.fromCache ||
            ((!this.options.Ku || !("Offline" !== t)) &&
              (!e.docs.isEmpty() || e.hasCachedResults || "Offline" === t))
          );
        }
        Lu(e) {
          if (0 < e.docChanges.length) return !0;
          var t = this.Bu && this.Bu.hasPendingWrites !== e.hasPendingWrites;
          return (
      ...
      class Nl {
        ...
        ur(e) {
          return e.metadata.exists
            ? mu(this.serializer, e.document, !1)
            : Xs.newNoDocument(
                this.rr(e.metadata.name),
                this.cr(e.metadata.readTime)
              );
        }
        cr(e) {
          return su(e);
      ...
      class kl {
        ...
        zu(e) {
          ...
          if (e.Gu.namedQuery) this.queries.push(e.Gu.namedQuery);
            ...
            this.documents.push({ metadata: e.Gu.documentMetadata }),
              e.Gu.documentMetadata.exists || ++t;
            const n = ii.fromString(e.Gu.documentMetadata.name);
        ...
        Wu(e) {
          const t = new Map(),
            n = new Nl(this.serializer);
          for (const i of e)
            if (i.metadata.queries) {
              const e = n.rr(i.metadata.name);
              for (const n of i.metadata.queries) {
                var r = (t.get(n) || Jo()).add(e);
                t.set(n, r);
              }
            }
          return t;
        ...
        async complete() {
          const e = await (async function (e, t, n, r) {
              ...
              for (const e of n) {
                ...
                const c = t.ur(e);
                c.setReadTime(t.cr(e.metadata.readTime)), (o = o.insert(n, c));
              }
              const a = i.Zi.newChangeBuffer({ trackRemovals: !0 }),
                u = await wh(
                  i,
                  ((r = r), Lo(Co(ii.fromString(`__bundle__/docs/${r}`))))
                );
              return i.persistence.runTransaction(
                ...
                (t) =>
                  vh(t, a, o)
                    .next((e) => (a.apply(t), e))
                    .next((e) =>
                      i.Bs.removeMatchingKeysForTargetId(t, u.targetId)
                        .next(() => i.Bs.addMatchingKeys(t, s, u.targetId))
                        .next(() =>
              ...
              this.localStore,
              new Nl(this.serializer),
              this.documents,
              this.ju.id
            ),
            t = this.Wu(this.documents);
          for (const e of this.queries)
            await (async function (e, n, r = Jo()) {
              const i = await wh(e, Lo(Lu(n.bundledQuery))),
                s = e;
              return s.persistence.runTransaction(
                ...
                (e) => {
                  ...
                  if (0 <= i.snapshotVersion.compareTo(t))
                    return s.qs.saveNamedQuery(e, n);
                  t = i.withResumeToken(Is.EMPTY_BYTE_STRING, t);
                  return (
                    (s.Ji = s.Ji.insert(t.targetId, t)),
                    s.Bs.updateTargetData(e, t)
                      .next(() =>
                        s.Bs.removeMatchingKeysForTargetId(e, i.targetId)
                      )
                      .next(() => s.Bs.addMatchingKeys(e, r, i.targetId))
                      .next(() => s.qs.saveNamedQuery(e, n))
                  );
                }
              );
          ...
          return (
            ...
            { progress: this.progress, Hu: this.collectionGroups, Ju: e }
          );
        }
      }
      function Rl(e) {
      ...
      class Ll {
        constructor(e, t) {
          (this.query = e),
            ...
            (this.mutatedKeys = Jo()),
            (this.tc = Go(e)),
            (this.ec = new bl(this.tc));
        }
        get nc() {
          return this.Yu;
        }
        sc(e, t) {
          const a = t ? t.ic : new Il(),
            u = (t || this).ec;
          ...
          if (
            (e.inorderTraversal((e, t) => {
              ...
              n && r
                ? n.data.isEqual(r.data)
                  ? i !== s && (a.track({ type: 3, doc: r }), (o = !0))
                  : this.rc(n, r) ||
                    (a.track({ type: 2, doc: r }),
                    (o = !0),
                    ((d && 0 < this.tc(r, d)) || (f && this.tc(r, f) < 0)) &&
                      (l = !0))
                : !n && r
            ...
            for (; h.size > this.query.limit; ) {
              ...
              (h = h.delete(e.key)),
                (c = c.delete(e.key)),
                a.track({ type: 1, doc: e });
            }
          return { ec: h, ic: a, zi: l, mutatedKeys: c };
        }
        rc(e, t) {
          return (
            e.hasLocalMutations &&
          ...
          i.sort(
            (e, t) =>
              (function (e, t) {
                ...
                return n(e) - n(t);
              })(e.type, t.type) || this.tc(e.doc, t.doc)
          ),
            this.oc(n);
          var s = t ? this.uc() : [],
            o = 0 === this.Zu.size && this.current ? 1 : 0,
            a = o !== this.Xu;
          return (
            (this.Xu = o),
            0 !== i.length || a
        ...
        ac(e) {
          return (
            !this.Yu.has(e) &&
            !!this.ec.has(e) &&
            !this.ec.get(e).hasLocalMutations
          );
        }
        oc(e) {
          e &&
        ...
        uc() {
          ...
          return (
            t.forEach((e) => {
              this.Zu.has(e) || n.push(new Fl(e));
            }),
            this.Zu.forEach((e) => {
              t.has(e) || n.push(new Ml(e));
            }),
            n
          );
        }
        hc(e) {
          (this.Yu = e.ir), (this.Zu = Jo());
          var t = this.sc(e.documents);
          return this.applyChanges(t, !0);
        }
        lc() {
          return El.fromInitialDocuments(
            this.query,
            this.ec,
            this.mutatedKeys,
            0 === this.Xu,
      ...
      class Pl {
        constructor(e, t, n, r, i, s) {
          (this.localStore = e),
            ...
            (this.dc = {}),
            (this.wc = new zo((e) => Bo(e), Po)),
            (this._c = new Map()),
            (this.mc = new Set()),
            (this.gc = new fs(ai.comparator)),
            (this.yc = new Map()),
            (this.Ic = new Wc()),
            (this.Tc = {}),
            (this.Ec = new Map()),
      ...
      async function Bl(n, e, t, r, i) {
        n.Rc = (e, s, t) =>
          (async function (e, t, n) {
            let r = t.view.sc(s);
            r.zi &&
              (r = await Ih(e.localStore, t.query, !1).then(
                ({ documents: e }) => t.view.sc(e, r)
              ));
            var i = n && n.targetChanges.get(t.targetId),
              i = t.view.applyChanges(r, e.isPrimaryClient, i);
            return Hl(e, t.targetId, i.cc), i.snapshot;
          })(n, e, t);
        const s = await Ih(n.localStore, e, !0),
          o = new Ll(e, s.ir),
          a = o.sc(s.documents),
          ...
          c = o.applyChanges(a, n.isPrimaryClient, u);
        Hl(n, t, c.cc);
        var h = new Ol(e, t, o);
        return (
          n.wc.set(e, h),
      ...
      async function ql(e, t, n) {
        ...
        try {
          const e = await (function (e, i) {
            const s = e,
              o = ti.now(),
              a = i.reduce((e, t) => e.add(t.key), Jo());
            let u, c;
            return s.persistence
              .runTransaction("Locally write mutations", "readwrite", (n) => {
                let t = $o,
                  r = Jo();
                return s.Zi.getEntries(n, a)
                  .next((e) => {
                    (t = e),
                      t.forEach((e, t) => {
                  ...
                  .next((e) => {
                      ...
                      const i = (function (e, t) {
                        ...
                        for (const r of e.fieldTransforms) {
                          const e = t.data.field(r.field),
                            i = ia(r.transform, e || null);
                          null != i &&
                            (null === n && (n = Ws.empty()), n.set(r.field, i));
                        }
                        return n || null;
                    ...
                    return s.mutationQueue.addMutationBatch(n, o, t, i);
                  })
                  .next((e) => {
              ...
              .then(() => ({ batchId: c.batchId, changes: Ho(u) }));
          })(r.localStore, t);
          r.sharedClientState.addPendingMutation(e.batchId),
            (function (e, t, n) {
              ...
              (r = r || new fs(Jr)),
                (r = r.insert(t, n)),
                (e.Tc[e.currentUser.toKey()] = r);
            })(r, e.batchId, n),
            await Xl(r, e.changes),
            await ll(r.remoteStore);
        } catch (e) {
          const t = wl(e, "Failed to persist write");
          n.reject(t);
        }
      }
          ...
          t.targetChanges.forEach((e, t) => {
            ...
            n &&
              ...
              0 < e.addedDocuments.size
                ...
                ? Br(n.fc)
                : 0 < e.removedDocuments.size && (Br(n.fc), (n.fc = !1)));
          }),
            await Xl(r, e, t);
        } catch (e) {
          await wi(e);
          ...
          t.wc.forEach((e, t) => {
            ...
            (function (e, n) {
              ...
              t.queries.forEach((e, t) => {
                for (const e of t.listeners) e.Mu(n) && (r = !0);
              }),
                r && Dl(t);
            })(t.eventManager, i),
            r.length && t.dc.nu(r),
            ...
            return i.persistence.runTransaction(
              ...
              (e) => {
                const t = r.batch.keys(),
                  n = i.Zi.newChangeBuffer({ trackRemovals: !0 });
      ...
      function Hl(e, t, n) {
        for (const r of n)
          r instanceof Ml
            ? (e.Ic.addReference(r.key, t),
              (function (e, t) {
                const n = t.key,
                  r = n.path.canonicalString();
                e.gc.get(n) ||
                  e.mc.has(r) ||
                  (Fr("SyncEngine", "New document in limbo: " + n),
                  e.mc.add(r),
                  Wl(e));
              })(e, r))
            : r instanceof Fl
            ? (Fr("SyncEngine", "Document no longer in limbo: " + r.key),
              e.Ic.removeReference(r.key, t),
              e.Ic.containsKey(r.key) || Ql(e, r.key))
            : Pr();
      }
      function Wl(e) {
        for (; 0 < e.mc.size && e.gc.size < e.maxConcurrentLimboResolutions; ) {
          var t = e.mc.values().next().value;
          e.mc.delete(t);
          var n = new ai(ii.fromString(t)),
            t = e.Ac.next();
          e.yc.set(t, new Vl(n)),
            (e.gc = e.gc.insert(n, t)),
            tl(
              e.remoteStore,
              new xu(Lo(Co(n.path)), t, "TargetPurposeLimboResolution", Ri.ct)
            );
        }
      }
            ...
            a.push(
              i.Rc(n, t, r).then((e) => {
                ...
                (e || r) &&
                  ...
                  e && (s.push(e), (t = lh.Li(n.targetId, e)), o.push(t));
              })
            );
          }),
          await Promise.all(a),
      ...
      async function Yl(r, e) {
        const i = r;
        if ((ed(i), td(i), !0 === e && !0 !== i.vc)) {
          const r = i.sharedClientState.getAllActiveQueryTargets(),
            e = await Jl(i, r.toArray());
          (i.vc = !0), await ml(i.remoteStore, !0);
          ...
          i._c.forEach((e, t) => {
            i.sharedClientState.isLocalQueryTarget(t)
              ? r.push(t)
              : (n = n.then(() => (Kl(i, t), bh(i.localStore, t, !0)))),
              nl(i.remoteStore, t);
          }),
            await n,
            await Jl(i, r),
            (function () {
              ...
              n.yc.forEach((e, t) => {
                ...
                n.Ic.Ts(),
                (n.yc = new Map()),
                (n.gc = new fs(ai.comparator));
            })(),
            (i.vc = !1),
            await ml(i.remoteStore, !1);
        }
      }
      async function Jl(t, n) {
        const r = t,
          i = [],
          s = [];
        for (const t of n) {
          ...
          const h = r._c.get(t);
          if (h && 0 !== h.length) {
            e = await wh(r.localStore, Lo(h[0]));
            for (const t of h) {
              const n = r.wc.get(t),
                h =
                  ((o = r),
                  (a = n),
                  (c = u = void 0),
                  (c = await Ih((u = o).localStore, a.query, !0)),
                  (c = a.view.hc(c)),
                  u.isPrimaryClient && Hl(u, a.targetId, c.cc),
                  await c);
              h.snapshot && s.push(h.snapshot);
            }
          } else {
            const h = await Eh(r.localStore, t);
            (e = await wh(r.localStore, h)),
              await Bl(r, Zl(h), t, !1, e.resumeToken);
          }
          i.push(e);
        }
        var o, a, u, c;
      ...
      function ed(e) {
        const t = e;
        return (
          (t.remoteStore.remoteSyncer.applyRemoteEvent = Ul.bind(null, t)),
          (t.remoteStore.remoteSyncer.getRemoteKeysForTarget = function (e, t) {
            const n = e,
              r = n.yc.get(t);
            if (r && r.fc) return Jo().add(r.key);
            {
              let e = Jo();
              const r = n._c.get(t);
              if (!r) return e;
          ...
          (t.remoteStore.remoteSyncer.rejectListen = async function (e, t, n) {
            ...
            const i = r.yc.get(t),
              s = i && i.key;
            if (s) {
              let e = new fs(ai.comparator);
              e = e.insert(s, Xs.newNoDocument(s, ni.min()));
              const n = Jo().add(s),
                i = new Ga(ni.min(), new Map(), new fs(Jr), e, n);
              await Ul(r, i), (r.gc = r.gc.remove(s)), r.yc.delete(t), Wl(r);
            } else
              await bh(r.localStore, t, !1)
                .then(() => Kl(r, t, n))
                .catch(wi);
          }.bind(null, t)),
          (t.dc.nu = function (e, t) {
            const n = e;
            let r = !1;
            for (const e of t) {
              const t = e.query,
                i = n.queries.get(t);
              if (i) {
                for (const t of i.listeners) t.$u(e) && (r = !0);
                i.Nu = e;
              }
            }
            r && Dl(n);
          }.bind(null, t.eventManager)),
          (t.dc.Pc = function (e, t, n) {
            const r = e,
              i = r.queries.get(t);
      ...
      function td(e) {
        const t = e;
        return (
          (t.remoteStore.remoteSyncer.applySuccessfulWrite = Gl.bind(null, t)),
      ...
      class nd {
        ...
        async initialize(e) {
          (this.serializer = $h(e.databaseInfo.databaseId)),
        ...
        createPersistence(e) {
          return new th(rh.zs, this.serializer);
        }
      ...
      class rd extends nd {
        ...
        async initialize(e) {
          await super.initialize(e),
            ...
            await td(this.Vc.syncEngine),
            await ll(this.Vc.remoteStore),
          ...
          var t = hh(e.databaseInfo.databaseId, e.databaseInfo.persistenceKey),
            n =
              void 0 !== this.cacheSizeBytes
                ? yc.withCacheSize(this.cacheSizeBytes)
                : yc.DEFAULT;
          return new ah(
      ...
      class id extends rd {
        ...
        async initialize(e) {
          await super.initialize(e);
          var t = this.Vc.syncEngine;
          this.sharedClientState instanceof Mh &&
            ((this.sharedClientState.syncEngine = {
              jr: async function (e, t, n, r) {
                ...
                null !== s
                  ? ("pending" === n
                      ? await ll(i.remoteStore)
                      : "acknowledged" === n || "rejected" === n
                      ? ($l(i, t, r || null),
                        zl(i, t),
                        i.localStore.mutationQueue.Cn(t))
                      : Pr(),
                    await Xl(i, s))
                  : Fr(
                      "SyncEngine",
                ...
                if (i.vc)
                  ...
                  if (s && 0 < s.length)
                    switch (n) {
                      case "current":
                      case "not-current": {
                        const e = await _h(i.localStore, jo(s[0])),
                      ...
                      case "rejected":
                        await bh(i.localStore, t, !0), Kl(i, t, r);
                        break;
                      default:
                        Pr();
                    }
              ...
              Wr: async function (e, t, n) {
                const r = ed(e);
                if (r.vc) {
                  for (const e of t)
                    if (r._c.has(e))
                      Fr("SyncEngine", "Adding an already active target " + e);
                    else {
                      const t = await Eh(r.localStore, e),
                        n = await wh(r.localStore, t);
                      await Bl(r, Zl(t), n.targetId, !1, n.resumeToken),
                        tl(r.remoteStore, n);
                    }
                  for (const e of n)
                    r._c.has(e) &&
              ...
              Qr: async function (e, t) {
                const n = e;
                return _h(n.localStore, t).then((e) => Xl(n, e));
              }.bind(null, t),
            }),
            await this.sharedClientState.start()),
            await this.persistence.Ii(async (e) => {
              await Yl(this.Vc.syncEngine, e),
                this.gcScheduler &&
      ...
      class sd {
        async initialize(e, t) {
          this.localStore ||
            ...
            await ml(this.remoteStore, this.syncEngine.isPrimaryClient));
        }
        ...
        createDatastore(e) {
          var t,
            ...
            r,
            i,
            s = $h(e.databaseInfo.databaseId),
            t = ((t = e.databaseInfo), new jh(t));
          return (
            (n = e.authCredentials),
        ...
        terminate() {
          return (async function (e) {
            const t = e;
            Fr("RemoteStore", "RemoteStore shutting down."),
              t.vu.add(5),
              await el(t),
              t.Pu.shutdown(),
              t.bu.set("Unknown");
      ...
      class ad {
        ...
        error(e) {
          this.observer.error
            ...
            : Lr("Uncaught Error in snapshot listener:", e.toString());
        }
        Dc() {
          this.muted = !0;
        }
      ...
      class ud {
        ...
        async $c(e) {
          for (; this.buffer.length < e; )
            (await this.Fc()) &&
              this.Mc("Reached the end of bundle when more is expected.");
          var t = this.xc.decode(this.buffer.slice(0, e));
          return (this.buffer = this.buffer.slice(e)), t;
        }
        Mc(e) {
      ...
      class cd {
        ...
        async lookup(e) {
          ...
          const t = await (async function (e, t) {
            const r = e,
              ...
              i = { documents: t.map((e) => uu(r.serializer, e)) },
              s = await r.vo("BatchGetDocuments", n, i, t.length),
              o = new Map();
            s.forEach((e) => {
              const t =
                ((n = r.serializer),
                "found" in (e = e)
                  ? (function (e, t) {
                      Br(!!t.found), t.found.name, t.found.updateTime;
                      var n = cu(e, t.found.name),
                        r = su(t.found.updateTime),
                        i = t.found.createTime
                          ? su(t.found.createTime)
                          : ni.min(),
                        s = new Ws({ mapValue: { fields: t.found.fields } });
                      return Xs.newFoundDocument(n, r, i, s);
                    })(n, e)
                  : "missing" in e
                  ? (function (e, t) {
                      Br(!!t.missing), Br(!!t.readTime);
        ...
        delete(e) {
          this.write(new Da(e, this.precondition(e))),
            this.writtenDocs.add(e.toString());
        }
        async commit() {
          ...
          this.mutations.forEach((e) => {
            ...
            await (async function (e, t) {
              const n = e,
                ...
                i = { writes: t.map((e) => pu(n.serializer, e)) };
        ...
        preconditionForUpdate(e) {
          const t = this.readVersions.get(e.toString());
          if (this.writtenDocs.has(e.toString()) || !t) return ma.exists(!0);
          if (t.isEqual(ni.min()))
            throw new Ur(
              qr.INVALID_ARGUMENT,
              "Can't update a document that doesn't exist."
            );
          return ma.updateTime(t);
        }
        write(e) {
      ...
      class hd {
        constructor(e, t, n, r, i) {
          (this.asyncQueue = e),
            ...
            (this.qo = new Kh(this.asyncQueue, "transaction_retry"));
        }
        run() {
          --this.Bc, this.Lc();
        }
      ...
      class ld {
        constructor(e, t, n, r) {
          (this.authCredentials = e),
            ...
            (this.asyncQueue = n),
            (this.databaseInfo = r),
            (this.user = Nr.UNAUTHENTICATED),
            (this.clientId = Yr.A()),
            (this.authCredentialListener = () => Promise.resolve()),
            (this.appCheckCredentialListener = () => Promise.resolve()),
            this.authCredentials.start(n, async (e) => {
              Fr("FirestoreClient", "Received user=", e.uid),
            ...
            this.appCheckCredentials.start(
              n,
              (e) => (
                Fr("FirestoreClient", "Received new app check token=", e),
          ...
          return (
            this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async () => {
              try {
                ...
                var t = wl(e, "Failed to shutdown persistence");
                n.reject(t);
              }
            }),
            n.promise
      ...
      async function dd(e, t) {
        e.asyncQueue.verifyOperationInProgress(),
          Fr("FirestoreClient", "Initializing OfflineComponentProvider");
      ...
      async function fd(e, n) {
        e.asyncQueue.verifyOperationInProgress();
        var t = await md(e);
        Fr("FirestoreClient", "Initializing OnlineComponentProvider");
        var r = await e.getConfiguration();
        await n.initialize(t, r),
          e.setCredentialChangeListener((e) => gl(n.remoteStore, e)),
          e.setAppCheckTokenChangeListener((e, t) => gl(n.remoteStore, t)),
          (e._onlineComponents = n);
      }
      function gd(e) {
        return "FirebaseError" === e.name
          ? e.code === qr.FAILED_PRECONDITION || e.code === qr.UNIMPLEMENTED
          : !(
      ...
      async function md(t) {
        if (!t._offlineComponents)
          if (t._uninitializedComponentsProvider) {
            ...
            try {
              await dd(t, t._uninitializedComponentsProvider._offline);
            } catch (e) {
              var n = e;
              if (!gd(n)) throw n;
              Or(
            ...
            Fr("FirestoreClient", "Using default OfflineComponentProvider"),
              await dd(t, new nd());
          ...
          e._onlineComponents ||
            (e._uninitializedComponentsProvider
              ? (Fr(
                ...
                await fd(e, e._uninitializedComponentsProvider._online))
              : (Fr("FirestoreClient", "Using default OnlineComponentProvider"),
                await fd(e, new sd()))),
          e._onlineComponents
        );
      }
      function yd(e) {
        return md(e).then((e) => e.persistence);
      }
      function vd(e) {
        return md(e).then((e) => e.localStore);
      }
      function wd(e) {
        return pd(e).then((e) => e.remoteStore);
      }
      function bd(e) {
        ...
        return (
          (n.onListen = async function (e, t) {
            ...
            if (s)
              ...
              const e = await wh(n.localStore, Lo(t)),
                s = n.sharedClientState.addLocalQueryTarget(e.targetId);
              (r = e.targetId),
                (i = await Bl(n, t, r, "current" === s, e.resumeToken)),
                n.isPrimaryClient && tl(n.remoteStore, e);
            }
            return i;
            ...
            n.isPrimaryClient
              ? (n.sharedClientState.removeLocalQueryTarget(r.targetId),
                n.sharedClientState.isActiveQueryTarget(r.targetId) ||
                  (await bh(n.localStore, r.targetId, !1)
                    .then(() => {
                      n.sharedClientState.clearQueryState(r.targetId),
                        nl(n.remoteStore, r.targetId),
                        Kl(n, r.targetId);
                    })
                    .catch(wi)))
              : (Kl(n, r.targetId), await bh(n.localStore, r.targetId, !0));
          }.bind(null, t.syncEngine)),
          n
        );
      }
          ...
          e.asyncQueue.enqueueAndForget(async () =>
            (function (n, r, i, s, o) {
              const e = new ad({
                ...
                a = new Al(Co(i.path), e, {
                  includeMetadataChanges: !0,
                  Ku: !0,
                });
              return Sl(n, a);
            })(await Id(e), e.asyncQueue, t, n, r)
          ),
          r.promise
        );
      }
          ...
          e.asyncQueue.enqueueAndForget(async () =>
            (function (t, n, e, r, i) {
              const s = new ad({
                ...
                o = new Al(e, s, { includeMetadataChanges: !0, Ku: !0 });
              return Sl(t, o);
            })(await Id(e), e.asyncQueue, t, n, r)
          ),
          r.promise
      ...
      function Td(e, t, n, r) {
        const i =
          ((n = n),
          (t = $h(t)),
          (s = "string" == typeof n ? Va().encode(n) : n),
          (n = (function (e) {
            if (e instanceof Uint8Array) return od(e, void 0);
            if (e instanceof ArrayBuffer) return od(new Uint8Array(e), void 0);
          ...
          !(function (e, t, n) {
            ...
            !(async function (t, n, r) {
              try {
                ...
                r._updateProgress(Rl(i));
                const o = new kl(i, t.localStore, n.serializer);
                let e = await n.bc();
                for (; e; ) {
                  const t = await o.zu(e);
                  t && r._updateProgress(t), (e = await n.bc());
                }
                var s = await o.complete();
                return (
                  await Xl(t, s.Ju, void 0),
                  await (function (e, t) {
                    const n = e;
                    return n.persistence.runTransaction(
                      "Save bundle",
                      "readwrite",
                      (e) => n.qs.saveBundleMetadata(e, t)
                    );
                  })(t.localStore, i),
                ...
                return (
                  Or("SyncEngine", `Loading bundle failed with ${t}`),
                  r._failWith(t),
                  Promise.resolve(new Set())
                );
              }
        ...
        _terminate() {
          return (
            (function (e) {
              const t = xd.get(e);
              t &&
                (Fr("ComponentProvider", "Removing Datastore"),
                xd.delete(e),
                t.terminate());
            })(this),
            Promise.resolve()
      ...
      function Od(n, e, t, r = {}) {
        var i;
        const s = (n = Rd(n, Ld))._getSettings();
        if (
          ...
          n._setSettings(
            Object.assign(Object.assign({}, s), { host: `${e}:${t}`, ssl: !1 })
          ),
          r.mockUserToken)
        ) {
          let e, t;
          if ("string" == typeof r.mockUserToken)
            (e = r.mockUserToken), (t = Nr.MOCK_USER);
          else {
            e = (function (e, t) {
              if (e.uid)
                throw new Error(
          ...
          n._authCredentials = new $r(new Gr(e, t));
        }
      }
      class Vd {
        constructor(e, t, n) {
        ...
        withConverter(e) {
          return new Vd(this.firestore, e, this._key);
        }
      }
      class Pd {
        constructor(e, t, n) {
        ...
        withConverter(e) {
          return new Pd(this.firestore, e, this._query);
        }
      }
      class Bd extends Pd {
        constructor(e, t, n) {
          super(e, t, Co(n)), (this._path = n), (this.type = "collection");
        }
        get id() {
        ...
        get parent() {
          ...
          return e.isEmpty() ? null : new Vd(this.firestore, null, new ai(e));
        }
        withConverter(e) {
      ...
      function qd(e, t, ...n) {
        if (((e = m(e)), Dd("collection", "path", t), e instanceof Ld)) {
          var r = ii.fromString(t, ...n);
          return Nd(r), new Bd(e, null, r);
        }
        if (!(e instanceof Vd || e instanceof Bd))
          throw new Ur(
            qr.INVALID_ARGUMENT,
            "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore"
          );
        r = e._path.child(ii.fromString(t, ...n));
        return Nd(r), new Bd(e.firestore, null, r);
      }
      function Ud(e, t, ...n) {
        if (
          ((e = m(e)),
          Dd("doc", "path", (t = 1 === arguments.length ? Yr.A() : t)),
          e instanceof Ld)
        ) {
          var r = ii.fromString(t, ...n);
          return Cd(r), new Vd(e, null, new ai(r));
        }
        if (!(e instanceof Vd || e instanceof Bd))
          throw new Ur(
            qr.INVALID_ARGUMENT,
        ...
        return (
          Cd(r),
          new Vd(e.firestore, e instanceof Bd ? e.converter : null, new ai(r))
        );
      }
      function jd(e, t) {
        return (
          (e = m(e)),
          (t = m(t)),
          (e instanceof Vd || e instanceof Bd) &&
            (t instanceof Vd || t instanceof Bd) &&
      ...
      class zd {
        constructor() {
          (this.Gc = Promise.resolve()),
            ...
            (this.Jc = !1),
            (this.Yc = []),
            (this.qo = new Kh(this, "async_queue_retry")),
            (this.Xc = () => {
              var e = zh();
              e &&
                Fr(
        ...
        async ea() {
          if (0 !== this.Qc.length) {
            ...
            0 < this.Qc.length && this.qo.No(() => this.ea());
          }
        }
        ta(e) {
          var t = this.Gc.then(
        ...
        enqueueAfterDelay(e, t, n) {
          this.Zc(), -1 < this.Yc.indexOf(e) && (t = 0);
          var r = vl.createAndSchedule(this, e, t, n, (e) => this.na(e));
        ...
        async sa() {
          for (var e; await (e = this.Gc), e !== this.Gc; );
        }
        ia(e) {
      ...
      class Kd {
        constructor() {
          (this._progressObserver = {}),
            (this._taskCompletionResolver = new jr()),
            (this._lastProgress = {
              taskState: "Running",
              totalBytes: 0,
              totalDocuments: 0,
      ...
      class Xd extends Ld {
        ...
        _terminate() {
          return (
            this._firestoreClient || Jd(this), this._firestoreClient.terminate()
          );
        }
      }
      function Yd(e) {
        return (
          e._firestoreClient || Jd(e),
        ...
        var t,
          ...
          a =
            ...
            new Cs(
              ...
              Sd(s.experimentalLongPollingOptions),
              s.useFetchStreams
            ));
        (e._firestoreClient = new ld(
          e._authCredentials,
          ...
          null !== (a = o.cache) &&
            void 0 !== a &&
            a._offlineComponentProvider &&
            null !== (t = o.cache) &&
            void 0 !== t &&
            t._onlineComponentProvider &&
            (e._firestoreClient._uninitializedComponentsProvider = {
              _offlineKind: o.cache.kind,
              _offline: o.cache._offlineComponentProvider,
              _online: o.cache._onlineComponentProvider,
            });
      }
      function Zd(e, t, n) {
        const r = new jr();
        return e.asyncQueue
          .enqueue(async () => {
            try {
              await dd(e, n), await fd(e, t), r.resolve();
            } catch (e) {
              const t = e;
              if (!gd(t)) throw t;
              Or(
      ...
      function tf(e) {
        return (n = Yd((e = Rd(e, Xd)))).asyncQueue.enqueue(async () => {
          const e = await yd(n),
            t = await wd(n);
          return (
      ...
      function nf(e) {
        return (n = Yd((e = Rd(e, Xd)))).asyncQueue.enqueue(async () => {
          ...
          return (
            ...
            (async function () {
              const e = t;
              e.vu.add(0), await el(e), e.bu.set("Offline");
            })()
          );
        });
        var n;
            ...
            .enqueue(async () =>
              (function (e, t) {
                ...
                return n.persistence.runTransaction(
                  "Get named query",
                  "readonly",
                  (e) => n.qs.getNamedQuery(e, t)
                );
              })(await vd(n), r)
            )
            .then((e) => (e ? new Pd(t, null, e.query) : null))
        );
        var n, r;
      }
      function sf(e) {
      ...
      class of {
        ...
        static fromBase64String(e) {
          try {
            return new of(Is.fromBase64String(e));
          } catch (e) {
            throw new Ur(
              qr.INVALID_ARGUMENT,
        ...
        static fromUint8Array(e) {
          return new of(Is.fromUint8Array(e));
        }
        toBase64() {
      ...
      class lf {
        ...
        toMutation(e, t) {
          return null !== this.fieldMask
            ? new _a(e, this.data, this.fieldMask, t, this.fieldTransforms)
            : new Ea(e, this.data, t, this.fieldTransforms);
        }
      }
      class df {
        constructor(e, t, n) {
        ...
        toMutation(e, t) {
          return new _a(e, this.data, this.fieldMask, t, this.fieldTransforms);
        }
      }
      function ff(e) {
        switch (e) {
      ...
      function pf(e) {
        var t = e._freezeSettings(),
          n = $h(e._databaseId);
        return new mf(e._databaseId, !!t.ignoreUndefinedProperties, n);
      }
      function yf(e, t, n, r, i, s = {}) {
        const o = e.ya(s.merge || s.mergeFields ? 2 : 0, t, n, i);
        Nf("Data must be an object, but it was:", o, r);
        var a = Af(r, o);
        let u, c;
        if (s.merge) (u = new ws(o.fieldMask)), (c = o.fieldTransforms);
          ...
          (u = new ws(e)),
            (c = o.fieldTransforms.filter((e) => u.covers(e.field)));
        } else (u = null), (c = o.fieldTransforms);
        return new lf(new Ws(a), u, c);
      }
      class vf extends uf {
        _toFieldTransform(e) {
          if (2 !== e.ca)
      ...
      function wf(e, t, n) {
        return new gf(
          { ca: 3, ga: t.settings.ga, methodName: e._methodName, la: n },
          t.databaseId,
          t.serializer,
      ...
      class If extends uf {
        ...
        _toFieldTransform(e) {
          const t = wf(this, e, !0),
            n = this.pa.map((e) => Df(e, t)),
            r = new oa(n);
          return new fa(e.path, r);
        }
        isEqual(e) {
          return this === e;
        }
      ...
      class _f extends uf {
        ...
        _toFieldTransform(e) {
          var t = new ha(e.serializer, na(e.serializer, this.Ia));
          return new fa(e.path, t);
        }
        isEqual(e) {
          return this === e;
        }
      ...
      function Tf(e, i, s, t) {
        const o = e.ya(1, i, s);
        Nf("Data must be an object, but it was:", o, t);
        const a = [],
          u = Ws.empty();
        ls(t, (e, t) => {
          var n = Mf(i, e, s);
          t = m(t);
          var r = o.da(n);
          if (t instanceof vf) a.push(n);
          else {
            const e = Df(t, r);
            null != e && (a.push(n), u.set(n, e));
          }
        });
        var n = new ws(a);
        return new df(u, n, o.fieldTransforms);
      }
      function Sf(e, t, n, r, i, s) {
        ...
        var d = new ws(c);
        return new df(h, d, o.fieldTransforms);
      }
      function xf(e, t, n, r = !1) {
        return Df(n, e.ya(r ? 4 : 3, t));
      }
      function Df(s, e) {
        if (Cf((s = m(s))))
          return Nf("Unsupported field value:", e, s), Af(s, e);
        if (s instanceof uf)
          return (
            (function (e, t) {
              if (!ff(t.ca))
        ...
        if (void 0 === s && e.ignoreUndefinedProperties) return null;
        ...
        return (function (e, t) {
          if (null === (e = m(s))) return { nullValue: "NULL_VALUE" };
          if ("number" == typeof e) return na(t.serializer, e);
          if ("boolean" == typeof e) return { booleanValue: e };
          if ("string" == typeof e) return { stringValue: e };
          if (e instanceof Date) {
            var n = ti.fromDate(e);
            return { timestampValue: ru(t.serializer, n) };
          }
          if (e instanceof ti) {
          ...
          if (e instanceof of)
            return { bytesValue: iu(t.serializer, e._byteString) };
          if (e instanceof Vd) {
          ...
          throw t._a(`Unsupported field value: ${kd(e)}`);
        })(0, e);
      }
      function Af(e, r) {
        const i = {};
      ...
      function Nf(e, t, n) {
        if (
          ...
          var r = kd(n);
          throw "an object" === r
            ? t._a(e + " a custom object")
            : t._a(e + " " + r);
        }
        var i;
      }
      function kf(e, t, n) {
        if ((t = m(t)) instanceof af) return t._internalPath;
        if ("string" == typeof t) return Mf(e, t);
        throw Ff(
      ...
      function Mf(t, n, r) {
        ...
        try {
          return new af(...n.split("."))._internalPath;
        } catch (e) {
          throw Ff(
      ...
      function Ff(e, t, n, r, i) {
        ...
        return (
          (s || o) &&
            ...
            o && (u += ` in document ${i}`),
            (u += ")")),
          new Ur(qr.INVALID_ARGUMENT, a + e + u)
        );
      }
      function Lf(e, t) {
      ...
      class Of {
        ...
        get ref() {
          return new Vd(this._firestore, this._converter, this._key);
        }
        exists() {
        ...
        get(e) {
          if (this._document) {
            var t = this._document.data.field(Pf("DocumentSnapshot.get", e));
      ...
      function Pf(e, t) {
        return "string" == typeof t
          ? Mf(e, t)
          : (t instanceof af ? t : t._delegate)._internalPath;
      }
      function Bf(e) {
      ...
      function jf(e, t, ...n) {
        let r = [];
        t instanceof qf && r.push(t),
          (r = r.concat(n)),
          (function (e) {
            var t = e.filter((e) => e instanceof zf).length,
              n = e.filter((e) => e instanceof Gf).length;
            if (1 < t || (0 < t && 0 < n))
              throw new Ur(
                qr.INVALID_ARGUMENT,
      ...
      class Gf extends Uf {
        ...
        _apply(e) {
          var t = this._parse(e);
          return (
            Jf(e._query, t), new Pd(e.firestore, e.converter, Oo(e._query, t))
          );
        }
        _parse(e) {
          var t = pf(e.firestore);
          return (function (e, t, n, r, i, s, o) {
            let a;
            if (i.isKeyField()) {
              ...
              if ("in" === s || "not-in" === s) {
                Yf(o, s);
                const t = [];
                for (const n of o) t.push(Xf(r, e, n));
                a = { arrayValue: { values: t } };
              } else a = Xf(r, e, o);
            } else
              ("in" !== s && "not-in" !== s && "array-contains-any" !== s) ||
                Yf(o, s),
                (a = xf(n, t, o, "in" === s || "not-in" === s));
      ...
      class zf extends qf {
        ...
        _parse(t) {
          ...
          return 1 === e.length ? e[0] : ro.create(e, this._getOperator());
        }
        _apply(e) {
          const n = this._parse(e);
          return 0 === n.getFilters().length
            ? e
            : ((function (e) {
                let t = e;
              ...
              new Pd(e.firestore, e.converter, Oo(e._query, n)));
        }
      ...
      class Kf extends Uf {
        ...
        _apply(e) {
          return new Pd(
            e.firestore,
            e.converter,
            Vo(e._query, this._limit, this._limitType)
          );
        }
      }
      class Qf extends Uf {
        ...
        _apply(e) {
          var t,
            n = Wf(e, this.type, this._docOrFields, this._inclusive);
          return new Pd(
            e.firestore,
            e.converter,
            ((t = e._query),
      ...
      function Wf(e, t, n, r) {
        if (((n[0] = m(n[0])), n[0] instanceof Of))
          return (function (e, t, n, r, i) {
            ...
            const s = [];
            for (const n of Fo(e))
              if (n.field.isKeyField()) s.push(Bs(t, r.key));
              else {
      ...
      function Xf(e, t, n) {
        if ("string" == typeof (n = m(n))) {
          ...
          return Bs(e, new ai(r));
        }
        if (n instanceof Vd) return Bs(e, n._key);
        throw new Ur(
          qr.INVALID_ARGUMENT,
          `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${kd(
            n
          )}.`
        );
      }
      ...
      class eg {
        ...
        convertGeoPoint(e) {
          return new cf(Ts(e.latitude), Ts(e.longitude));
        }
        convertArray(e, t) {
      ...
      class ng extends eg {
        ...
        convertReference(e) {
          ...
          return new Vd(this.firestore, null, t);
        }
      }
      class rg {
        constructor(e, t) {
      ...
      class ig extends Of {
        ...
        get(e, t = {}) {
          if (this._document) {
            var n = this._document.data.field(Pf("DocumentSnapshot.get", e));
            if (null !== n)
      ...
      class og {
        constructor(e, t, n, r) {
          (this._firestore = e),
            (this._userDataWriter = t),
            (this._snapshot = r),
            (this.metadata = new rg(r.hasPendingWrites, r.fromCache)),
            (this.query = n);
        }
        get docs() {
          const t = [];
      ...
      function ag(e, t) {
        return e instanceof ig && t instanceof ig
        ...
        return (function (e, t) {
            ...
            e.asyncQueue.enqueueAndForget(async () =>
              (async function (e, t, n) {
                try {
                  ...
                  var r = wl(e, `Failed to get document '${t} from cache`);
                  n.reject(r);
                }
              })(await vd(e), t, n)
            ),
          ...
          (e) =>
            new ig(
              ...
              t._key,
              e,
              new rg(null !== e && e.hasLocalMutations, !0),
              t.converter
            )
        );
      }
      function hg(t) {
              ...
              (async function (e, t, n) {
                try {
                  const i = await Ih(e, t, !0),
                    s = new Ll(t, i.ir),
                    o = s.sc(i.documents),
                    a = s.applyChanges(o, !1);
                  n.resolve(a.snapshot);
                } catch (e) {
                  var r = wl(e, `Failed to execute query '${t} against cache`);
                  n.reject(r);
                }
              })(await vd(e), t, n)
            ),
        ...
        })(e, t._query).then((e) => new og(n, r, t, e));
      }
      function lg(e, t, n) {
        e = Rd(e, Vd);
        var r = Rd(e.firestore, Xd),
          i = tg(e.converter, t, n);
        return mg(r, [
          yf(pf(r), "setDoc", e._key, i, null !== e.converter, n).toMutation(
            e._key,
            ma.none()
          ),
        ]);
      ...
      function dg(e, t, n, ...r) {
        e = Rd(e, Vd);
        var i = Rd(e.firestore, Xd),
          s = pf(i);
        let o;
        return (
          (o =
            "string" == typeof (t = m(t)) || t instanceof af
              ? Sf(s, "updateDoc", e._key, t, n, r)
              : Tf(s, "updateDoc", e._key, t)),
          mg(i, [o.toMutation(e._key, ma.exists(!0))])
        );
      }
      function fg(t, ...n) {
        var e;
        ...
        let r = { includeMetadataChanges: !1 },
          i = 0;
        "object" != typeof n[i] || $d(n[i]) || ((r = n[i]), i++);
        var s = { includeMetadataChanges: r.includeMetadataChanges };
        if ($d(n[i])) {
          const t = n[i];
        ...
        if (t instanceof Vd)
          ...
          const c = Rd(t, Pd);
          (a = Rd(c.firestore, Xd)), (u = c._query);
          const h = new ug(a);
          (o = {
            next: (e) => {
              n[i] && n[i](new og(a, h, c, e));
            },
            error: n[i + 1],
            complete: n[i + 2],
          }),
        ...
        return (function (e, t, n, r) {
          const i = new ad(r),
            s = new Al(t, i, n);
          return (
            e.asyncQueue.enqueueAndForget(async () => Sl(await Id(e), s)),
            () => {
              i.Dc(),
                e.asyncQueue.enqueueAndForget(async () => xl(await Id(e), s));
            }
          );
        })(Yd(a), u, s, o);
      }
      function gg(e, t) {
        ...
        })(Yd((e = Rd(e, Xd))), $d(t) ? t : { next: t });
      }
      function mg(e, t) {
        return (function (e, t) {
          const n = new jr();
          return (
            e.asyncQueue.enqueueAndForget(async () => ql(await bd(e), t, n)),
            n.promise
          );
        })(Yd(e), t);
      }
      function pg(e, t, n) {
        ...
        return new ig(
          ...
          t._key,
          r,
          new rg(n.hasPendingWrites, n.fromCache),
          t.converter
        );
      }
      const yg = { maxAttempts: 5 };
      class vg {
        constructor(e, t) {
          (this._firestore = e),
            ...
            (this._mutations = []),
            (this._committed = !1),
            (this._dataReader = pf(e));
        }
        set(e, t, n) {
          this._verifyNotCommitted();
          const r = wg(e, this._firestore),
            i = tg(r.converter, t, n),
            s = yf(
              this._dataReader,
              "WriteBatch.set",
              r._key,
          ...
          return this._mutations.push(s.toMutation(r._key, ma.none())), this;
        }
        update(e, t, n, ...r) {
          this._verifyNotCommitted();
          var i = wg(e, this._firestore);
          let s;
          return (
            (s =
              "string" == typeof (t = m(t)) || t instanceof af
                ? Sf(this._dataReader, "WriteBatch.update", i._key, t, n, r)
                : Tf(this._dataReader, "WriteBatch.update", i._key, t)),
            this._mutations.push(s.toMutation(i._key, ma.exists(!0))),
            this
          );
        }
        delete(e) {
          this._verifyNotCommitted();
          var t = wg(e, this._firestore);
          return (
            (this._mutations = this._mutations.concat(
              new Da(t._key, ma.none())
            )),
            this
          );
        }
      ...
      class bg extends class {
        ...
        get(e) {
          const n = wg(e, this._firestore),
            r = new ng(this._firestore);
          return this._transaction.lookup([n._key]).then((e) => {
            if (!e || 1 !== e.length) return Pr();
            const t = e[0];
            if (t.isFoundDocument())
              return new Of(this._firestore, r, t.key, t, n.converter);
            if (t.isNoDocument())
              return new Of(this._firestore, r, n._key, null, n.converter);
            throw Pr();
          });
        }
        set(e, t, n) {
          var r = wg(e, this._firestore),
            i = tg(r.converter, t, n),
            i = yf(
              this._dataReader,
              "Transaction.set",
        ...
        update(e, t, n, ...r) {
          var i = wg(e, this._firestore),
            s =
              "string" == typeof (t = m(t)) || t instanceof af
                ? Sf(this._dataReader, "Transaction.update", i._key, t, n, r)
                : Tf(this._dataReader, "Transaction.update", i._key, t);
        ...
        get(e) {
          const t = wg(e, this._firestore),
            n = new ug(this._firestore);
          return super
            .get(e)
            .then(
              (e) =>
      ...
      function Ig(t, n, e) {
        t = Rd(t, Xd);
        var r = Object.assign(Object.assign({}, yg), e);
        return (
          (function () {
            if (r.maxAttempts < 1)
              throw new Ur(
          ...
          (function (t, n, r) {
            ...
            return (
              t.asyncQueue.enqueueAndForget(async () => {
                var e = await pd(t).then((e) => e.datastore);
                new hd(t.asyncQueue, e, r, n, i).run();
              }),
              i.promise
            );
          })(Yd(t), (e) => n(new bg(t, e)), r)
        );
      }
      (Qd = Hg.SDK_VERSION),
        (kr = Qd),
        Hg._registerComponent(
          new p(
            "firestore",
            (e, { instanceIdentifier: t, options: n }) => {
              const r = e.getProvider("app").getImmediate(),
                i = new Xd(
                  new Kr(e.getProvider("auth-internal")),
                  new Xr(e.getProvider("app-check-internal")),
                  (function (e, t) {
                    if (
        ...
        Hg.registerVersion(Cr, "3.12.1", void 0),
        Hg.registerVersion(Cr, "3.12.1", "esm2017");
      function Eg(e, t) {
      ...
      class Sg {
        ...
        static fromBase64String(e) {
          return Tg(), new Sg(of.fromBase64String(e));
        }
        static fromUint8Array(e) {
          return _g(), new Sg(of.fromUint8Array(e));
        }
        toBase64() {
          return Tg(), this._delegate.toBase64();
        }
        toUint8Array() {
          return _g(), this._delegate.toUint8Array();
        }
        isEqual(e) {
        ...
        enableIndexedDbPersistence(e, t) {
          return (function (e, t) {
            ...
            return Zd(
              n,
              i,
              new rd(i, r.cacheSizeBytes, null == t ? void 0 : t.forceOwnership)
            );
        ...
        enableMultiTabIndexedDbPersistence(e) {
          return (function (e) {
            ...
            var n = e._freezeSettings(),
              r = new sd();
            return Zd(t, r, new id(r, n.cacheSizeBytes));
          })(e._delegate);
        }
          ...
          return (function (e) {
            ...
            return (
              e._queue.enqueueAndForgetEvenWhileRestricted(async () => {
                try {
                  await (async function (e) {
                    if (!Ei.D()) return Promise.resolve();
                    var t = e + "main";
                    await Ei.delete(t);
                  })(hh(e._databaseId, e._persistenceKey)),
                    t.resolve();
                } catch (e) {
                  t.reject(e);
                }
      ...
      class Ag {
        ...
        useEmulator(e, t, n = {}) {
          Od(this._delegate, e, t, n);
        }
        enableNetwork() {
          return tf(this._delegate);
        }
        disableNetwork() {
          return nf(this._delegate);
        }
        enablePersistence(e) {
          let t = !1,
            n = !1;
          return (
            e &&
              ...
              Ad("synchronizeTabs", t, "experimentalForceOwningTab", n)),
            t
        ...
        waitForPendingWrites() {
          return ef(this._delegate);
        }
        onSnapshotsInSync(e) {
          return gg(this._delegate, e);
        }
        get app() {
          if (!this._appCompat)
            throw new Ur(
        ...
        collection(e) {
          try {
            return new jg(this, qd(this._delegate, e));
          } catch (e) {
            throw Fg(e, "collection()", "Firestore.collection()");
          }
        }
        doc(e) {
          try {
            return new Mg(this, Ud(this._delegate, e));
          } catch (e) {
            throw Fg(e, "doc()", "Firestore.doc()");
          }
        }
        collectionGroup(e) {
          try {
            return new Bg(
              ...
              (function (e, t) {
                if (
                  ((e = Rd(e, Ld)),
                  Dd("collectionGroup", "collection id", t),
                  0 <= t.indexOf("/"))
                )
                  throw new Ur(
                    qr.INVALID_ARGUMENT,
                ...
                return new Pd(e, null, ((t = t), new Do(ii.emptyPath(), t)));
              })(this._delegate, e)
            );
          } catch (e) {
            throw Fg(e, "collectionGroup()", "Firestore.collectionGroup()");
          }
        }
        runTransaction(t) {
          return Ig(this._delegate, (e) => t(new Ng(this, e)));
        }
        batch() {
          return (
            Yd(this._delegate),
            new kg(new vg(this._delegate, (e) => mg(this._delegate, e)))
          );
        }
        loadBundle(e) {
          return (
            ...
            (n = Yd((t = Rd(t, Xd)))),
            (r = new Kd()),
            Td(n, t._databaseId, e, r),
            r
          );
          var t, n, r;
        }
        namedQuery(e) {
          return rf(this._delegate, e).then((e) =>
            e ? new Bg(this, e) : null
          );
        }
      }
      class Cg extends eg {
        ...
        convertBytes(e) {
          return new Sg(new of(e));
        }
        convertReference(e) {
          var t = this.convertDocumentKey(e, this.firestore._databaseId);
          return Mg.forKey(t, this.firestore, null);
        }
      }
      class Ng {
        constructor(e, t) {
        ...
        set(e, t, n) {
          ...
          return (
            n
              ? (Eg("Transaction.set", n), this._delegate.set(r, t, n))
      ...
      class kg {
        ...
        set(e, t, n) {
          ...
          return (
            n
              ? (Eg("WriteBatch.set", n), this._delegate.set(r, t, n))
              : this._delegate.set(r, t),
            this
          );
        }
      ...
      class Rg {
        ...
        static getInstance(e, t) {
          const n = Rg.INSTANCES;
          let r = n.get(e);
          r || ((r = new WeakMap()), n.set(e, r));
          let i = r.get(t);
          return i || ((i = new Rg(e, new Cg(e), t)), r.set(t, i)), i;
        }
      }
      ...
      class Mg {
        ...
        static forPath(e, t, n) {
          ...
          return new Mg(t, new Vd(t._delegate, n, new ai(e)));
        }
        static forKey(e, t, n) {
          return new Mg(t, new Vd(t._delegate, n, e));
        }
        get id() {
        ...
        collection(e) {
          try {
            return new jg(this.firestore, qd(this._delegate, e));
          } catch (e) {
            throw Fg(e, "collection()", "DocumentReference.collection()");
          }
        }
        isEqual(e) {
          return (e = m(e)) instanceof Vd && jd(this._delegate, e);
        }
        set(e, t) {
          t = Eg("DocumentReference.set", t);
          try {
            return t ? lg(this._delegate, e, t) : lg(this._delegate, e);
          } catch (e) {
            throw Fg(e, "setDoc()", "DocumentReference.set()");
          }
        }
        update(e, t, ...n) {
          try {
            return 1 === arguments.length
              ? dg(this._delegate, e)
              : dg(this._delegate, e, t, ...n);
          } catch (e) {
            throw Fg(e, "updateDoc()", "DocumentReference.update()");
          }
        }
        delete() {
          return mg(Rd((e = this._delegate).firestore, Xd), [
            new Da(e._key, ma.none()),
          ]);
          var e;
        }
        onSnapshot(...e) {
            ...
            (t = (
              "cache" === (null == e ? void 0 : e.source)
                ...
                ? function (t) {
                    t = Rd(t, Vd);
                    const n = Rd(t.firestore, Xd);
                    return Ed(Yd(n), t._key, { source: "server" }).then((e) =>
                      pg(n, t, e)
                    );
                  }
                : function (t) {
                    t = Rd(t, Vd);
                    const n = Rd(t.firestore, Xd);
                    return Ed(Yd(n), t._key).then((e) => pg(n, t, e));
                  }
            )(this._delegate)),
            t.then(
              (e) =>
        ...
        withConverter(e) {
          return new Mg(
            this.firestore,
            e
              ? this._delegate.withConverter(Rg.getInstance(this.firestore, e))
      ...
      function Lg(e) {
        for (const t of e) if ("object" == typeof t && !xg(t)) return t;
        return {};
      }
      function Og(e, t) {
        var n;
      ...
      class Vg {
        ...
        get ref() {
          return new Mg(this._firestore, this._delegate.ref);
        }
        get id() {
          return this._delegate.id;
        }
        ...
        isEqual(e) {
          return ag(this._delegate, e._delegate);
        }
      }
      class Pg extends Vg {
        data(e) {
        ...
        where(e, t, n) {
          try {
            return new Bg(
              ...
              jf(
                this._delegate,
                ((r = n), (i = t), (s = Pf("where", e)), Gf._create(s, i, r))
              )
            );
          } catch (e) {
            throw Fg(e, /(orderBy|where)\(\)/, "Query.$1()");
          }
          var r, i, s;
        }
        orderBy(e, t) {
        ...
        limit(e) {
          try {
            return new Bg(
              ...
              jf(
                this._delegate,
                (Md("limit", (t = e)), Kf._create("limit", t, "F"))
              )
            );
          } catch (e) {
            throw Fg(e, "limit()", "Query.limit()");
          }
          var t;
        }
        limitToLast(e) {
          try {
            return new Bg(
              ...
              jf(
                this._delegate,
                (Md("limitToLast", (t = e)), Kf._create("limitToLast", t, "L"))
              )
            );
          } catch (e) {
            throw Fg(e, "limitToLast()", "Query.limitToLast()");
          }
          var t;
        }
        startAt(...e) {
          try {
            return new Bg(
              ...
              jf(
                this._delegate,
                (function (...e) {
                  return Qf._create("startAt", e, !0);
                })(...e)
              )
            );
          } catch (e) {
            throw Fg(e, "startAt()", "Query.startAt()");
          }
        }
        startAfter(...e) {
          try {
            return new Bg(
              ...
              jf(
                this._delegate,
                (function (...e) {
                  return Qf._create("startAfter", e, !1);
                })(...e)
              )
            );
          } catch (e) {
            throw Fg(e, "startAfter()", "Query.startAfter()");
          }
        }
        endBefore(...e) {
          try {
            return new Bg(
              ...
              jf(
                this._delegate,
                (function (...e) {
                  return Hf._create("endBefore", e, !1);
                })(...e)
              )
            );
          } catch (e) {
            throw Fg(e, "endBefore()", "Query.endBefore()");
          }
        }
        endAt(...e) {
          try {
            return new Bg(
              ...
              jf(
                this._delegate,
                (function (...e) {
                  return Hf._create("endAt", e, !0);
                })(...e)
              )
            );
          } catch (e) {
            throw Fg(e, "endAt()", "Query.endAt()");
          }
        }
        isEqual(e) {
              ...
              "cache" === (null == e ? void 0 : e.source)
                ...
                ? function (t) {
                    ...
                    const n = Rd(t.firestore, Xd),
                      e = Yd(n),
                      r = new ug(n);
                    return _d(e, t._query, { source: "server" }).then(
                      (e) => new og(n, r, t, e)
                    );
                  }
                : function (t) {
                    ...
                    return (
                      Bf(t._query),
                      _d(e, t._query).then((e) => new og(n, r, t, e))
                    );
                  }
            )(this._delegate)),
            t.then(
      ...
      class qg {
        ...
        get doc() {
          return new Pg(this._firestore, this._delegate.doc);
        }
        get oldIndex() {
      ...
      class Ug {
        ...
        get query() {
          return new Bg(this._firestore, this._delegate.query);
        }
        get metadata() {
          return this._delegate.metadata;
        }
        ...
        get docs() {
          return this._delegate.docs.map((e) => new Pg(this._firestore, e));
        }
        docChanges(e) {
          return this._delegate
            .docChanges(e)
            .map((e) => new qg(this._firestore, e));
        }
        forEach(t, n) {
          this._delegate.forEach((e) => {
            t.call(n, new Pg(this._firestore, e));
          });
        }
        isEqual(e) {
          return ag(this._delegate, e._delegate);
      ...
      class jg extends Bg {
        ...
        get parent() {
          ...
          return e ? new Mg(this.firestore, e) : null;
        }
        doc(e) {
          try {
            return void 0 === e
              ? new Mg(this.firestore, Ud(this._delegate))
              : new Mg(this.firestore, Ud(this._delegate, e));
          } catch (e) {
            throw Fg(e, "doc()", "CollectionReference.doc()");
          }
        }
        add(e) {
          return (function (e, t) {
            const n = Rd(e.firestore, Xd),
              r = Ud(e),
              i = tg(e.converter, t);
            return mg(n, [
              yf(
                ...
                null !== e.converter,
                {}
              ).toMutation(r._key, ma.exists(!1)),
            ]).then(() => r);
          })(this._delegate, e).then((e) => new Mg(this.firestore, e));
        }
        isEqual(e) {
          return jd(this._delegate, e._delegate);
        }
        withConverter(e) {
          return new jg(
            this.firestore,
      ...
      const zg = {
        ...
        Transaction: Ng,
        WriteBatch: kg,
        DocumentReference: Mg,
        DocumentSnapshot: Vg,
        Query: Bg,
        QueryDocumentSnapshot: Pg,
        QuerySnapshot: Ug,
        CollectionReference: jg,
        FieldPath: class $g {
          constructor(...e) {
            this._delegate = new af(...e);
          }
          static documentId() {
            return new $g(oi.keyField().canonicalString());
          }
          isEqual(e) {
            return (
              (e = m(e)) instanceof af &&
        ...
        FieldValue: class Kg {
          ...
          static serverTimestamp() {
            const e = new bf("serverTimestamp");
            return (e._methodName = "FieldValue.serverTimestamp"), new Kg(e);
          }
          static delete() {
            const e = new vf("deleteField");
            return (e._methodName = "FieldValue.delete"), new Kg(e);
          }
          static arrayUnion(...e) {
            const t = (function (...e) {
              return new If("arrayUnion", e);
            })(...e);
            return (t._methodName = "FieldValue.arrayUnion"), new Kg(t);
          }
          static arrayRemove(...e) {
            const t = (function (...e) {
              return new Ef("arrayRemove", e);
            })(...e);
            return (t._methodName = "FieldValue.arrayRemove"), new Kg(t);
          }
          static increment(e) {
            const t = new _f("increment", e);
            return (t._methodName = "FieldValue.increment"), new Kg(t);
          }
          isEqual(e) {
            return this._delegate.isEqual(e._delegate);
          }
      ...
      (Hd = t.default),
        (Wd = (e, t) => new Ag(e, t, new Dg())),
        Hd.INTERNAL.registerComponent(
          new p(
            "firestore-compat",
            (e) => {
            ...
            "PUBLIC"
          ).setServiceProps(Object.assign({}, zg))
        ),
        Hd.registerVersion("@firebase/firestore-compat", "0.3.10");
